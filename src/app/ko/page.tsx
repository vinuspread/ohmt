...
const koTemplates: TemplateItem[] = [
  { id: 'technology', name: 'Technology', url: '/ko/templates/technology', desc: '미래지향적 AI 및 모듈형 로봇 시스템 카탈로그.', category: '생산성 & 문서', image: '/templates/technology/hero-bg.jpg', isFeatured: true },
  { id: 'fashion', name: 'Fashion', url: '/ko/templates/fashion', desc: '미니멀리스트 럭셔리 부티크 및 런웨이 카탈로그.', category: '패션 & 라이프스타일', image: '/templates/fashion/hero-custom.jpg' },
  { id: 'jewelry', name: 'Jewelry', url: '/ko/templates/jewelry', desc: '프리미엄 주얼리 및 맞춤형 보석 전시.', category: '럭셔리 & 리테일', image: '/templates/jewelry/thumbnail.png' },
  { id: 'exhibition', name: 'Exhibition', url: '/ko/templates/exhibition', desc: '박물관 디지털 포털 및 아카이브 갤러리.', category: '문화 & 예술', image: '/templates/exhibition/hero-bg.png' },
  { id: 'furniture', name: 'Furniture', url: '/ko/templates/furniture', desc: '현대적인 인테리어 디자인과 유기적인 공간 연출.', category: '인테리어 & 데코', image: '/templates/furniture/lifestyle-narrative.png' },
  { id: 'sneaker', name: 'Sneakers', url: '/ko/templates/sneaker', desc: '도시 거리를 지배하는 프리미엄 스니커즈 컬렉션.', category: '스포츠 & 스트리트웨어', image: '/templates/sneaker/hero-main.jpg' },
  { id: 'studio', name: 'Studio', url: '/ko/templates/studio', desc: '건축적 정밀함과 공간의 미학을 담은 스튜디오.', category: '에이전시 & 포트폴리오', image: '/templates/studio/hero-1.jpg' },
  { id: 'portfolio', name: 'Portfolio', url: '/ko/templates/portfolio', desc: '창작자의 일상과 사색을 담은 개인 저널.', category: '개인 & 크리에이티브', image: '/templates/portfolio/portfolio-hero.png' },
  { id: 'airline', name: 'Airline', url: '/ko/templates/airline', desc: '프리미엄 비행 경험과 하늘 위의 럭셔리.', category: '여행 & 교통', image: '/templates/airline/destination-3.jpg' },
  { id: 'car', name: 'Car Concept', url: '/ko/templates/car', desc: '미래지향적인 하이엔드 럭셔리 자동차 쇼케이스.', category: '자동차', image: '/templates/car/hero-1.jpg' },
  { id: 'cosmetic', name: 'Cosmetic', url: '/ko/templates/cosmetic', desc: '고기능성 스킨케어와 청정한 오가닉 뷰티의 조화.', category: '뷰티 & 웰니스', image: '/templates/cosmetic/cosmetic-hero-luxury.jpg' },
  { id: 'ir', name: 'Investor Relations', url: '/ko/templates/ir', desc: '투명성으로 구축하는 지속가능한 미래.', category: '금융 & 기업', image: '/templates/ir/ir-2.jpg' },
  { id: 'magazine', name: 'Magazine', url: '/ko/templates/magazine', desc: '시대를 관통하는 문화와 예술의 큐레이션.', category: '미디어 & 에디토리얼', image: '/templates/magazine/mag-hero.jpg' },
  { id: 'newspaper', name: 'Newspaper', url: '/ko/templates/newspaper', desc: '정밀한 분석과 깊이 있는 저널리즘.', category: '뉴스 & 출판', image: '/templates/newspaper/news-1.jpg' },
  { id: 'docs', name: 'Docs', url: '/ko/templates/docs', desc: '팀을 위한 노션 스타일 협업 문서 워크스페이스.', category: '생산성 & 문서', image: '/templates/docs/thumbnail.png' },
  { id: 'dashboard', name: 'Dashboard', url: '/ko/templates/dashboard', desc: '차트와 KPI 지표를 한눈에 - 비즈니스 분석 대시보드.', category: '생산성 & 문서', image: '/templates/dashboard/thumbnail.png' },
  { id: 'multi-shop', name: 'Multi Shop', url: '/ko/templates/multi-shop', desc: '다양한 카테고리를 갖춘 모던 패션 멀티샵 템플릿.', category: '패션 & 라이프스타일', image: '/templates/multi-shop/thumbnail.jpg' },
];
...
export default function LandingPageKo() {
  ...
  const featuredItem = useMemo(() => {
    ...
    return koTemplates.find(t => t.isFeatured) || null;
  }, [activeCategory, searchTerm]);
        ...
        <section className="pt-20 pb-16 bg-white border-b border-zinc-200/50 relative overflow-hidden dark:bg-zinc-900 dark:border-zinc-800">
          ...
          <div className="relative mt-16 w-full overflow-hidden select-none pointer-events-auto">
            ...
            <div className="animate-marquee flex gap-6 py-8">
              {[...koTemplates, ...koTemplates].map((template, idx) => (
                <Link
                  href={template.url}
                  key={`${template.id}-${idx}`}
                    ...
                    {gridItems.map((template) => (
                      ...
                      >
                        ...
                        <div className="p-6 space-y-4">
                          ...
                          <p className="text-sm text-zinc-500 leading-relaxed font-light dark:text-zinc-400">{template.desc}</p>
