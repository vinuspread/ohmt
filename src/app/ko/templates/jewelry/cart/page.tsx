    ...
    <TemplateWrapper theme={theme}>
      ...
      <header className="fixed top-0 w-full z-50 border-b border-neutral-100 bg-white">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 h-20 flex items-center justify-between">
          <Link href="/ko/templates/OHMT002-jewelry-KO" className="text-xs uppercase tracking-[0.4em] font-bold text-neutral-400 hover:text-[var(--color-primary)]">Back to Boutique</Link>
          <div className="absolute left-1/2 -translate-x-1/2">
            <Link href="/ko/templates/OHMT002-jewelry-KO" className="text-3xl font-serif tracking-[0.25em] font-normal uppercase text-neutral-900">Oh My Template</Link>
          </div>
      ...
      <div className="pt-48 pb-16 md:pb-32 px-6 max-w-[1440px] mx-auto">
            ...
            <div className="space-y-12">
              {cartItems.map(item => (
                <div key={item.id} className="flex flex-col md:flex-row gap-12 border-b border-neutral-200 pb-12">
                  <div className="w-full md:w-60 aspect-square bg-white border border-neutral-100 overflow-hidden">
                    <img loading="lazy" src={item.img} className="w-full h-full object-cover grayscale-[0.3]" alt={item.name} />
                  </div>
