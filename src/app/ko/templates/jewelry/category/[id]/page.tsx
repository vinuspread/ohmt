// src/app/ko/templates/OHMT002-jewelry/category/[id]/page.tsx
"use client";
          ...
          <div className="space-y-32">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-6 sm:gap-x-10 gap-y-12 sm:gap-y-24">
              {displayedProducts.map((item, i) => (
                <Link key={item.id} href={`/ko/templates/OHMT002-jewelry/product/${item.id}`} className="group block space-y-6">
                  <motion.div
