...
const sitemapLeft = [
  ...
  { label: "멤버십", href: `${basePath}/pricing` },
];

const sitemapRight = [
  { label: "전문가", href: `${basePath}/therapists` },
  ...
  return (
    <footer className="bg-[var(--color-secondary)] text-[var(--color-text-contrast)]">
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        <div>
          <h3 className="font-[family-name:var(--font-heading)] text-lg font-bold mb-4">웰니스 소식</h3>
          <p className="text-sm text-white/60 mb-4">계절별 피부 관리 팁과 새로운 프로그램 소식을 이메일로 받아보세요.</p>
