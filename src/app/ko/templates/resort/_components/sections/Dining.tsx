...
const tabs = [
  {
    label: "레스토랑",
    heading: "해변이 빚어낸 테이블",
    body: "미쉐린 스타를 받은 OHMT 레스토랑은 고대 건축과 해안의 빛이 어우러진 공간입니다. 천장부터 바닥까지 이어진 창문이 바다를 프레임에 담고, 모든 접시가 풍경을 이야기합니다.",
    image: "/templates/resort/dining.jpg",
  },
  {
    label: "바",
    heading: "어둠이 내리면, 바가 해변이 됩니다",
    body: "수제 칵테일이 파도의 리듬을 만납니다. 돌과 목재, 그리고 바다 저녁의 느린 박동으로 지어진 아늑한 공간.",
    image: "/templates/resort/gallery-4.jpg",
  },
  {
    label: "테라스",
    heading: "열린 공간, 열린 지평선",
    body: "당신과 바다 사이에 아무것도 없는 별빛 아래에서의 식사. 테라스는 선셋 만찬과 프라이빗 이벤트를 위한 가장 원초적인 공간입니다.",
    image: "/templates/resort/gallery-5.jpg",
  },
  {
    label: "비치 카페",
    heading: "물 위로 떠오르는 아침 빛",
    body: "맨발의 아침 식사, 냉압착 주스, 느린 오전. 비치 카페는 하루가 시작되는 곳입니다. 짭짤한 바다 공기와 함께 부드럽게.",
      ...
      <div className="max-w-[1440px] mx-auto px-10">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-[clamp(36px,4vw,56px)] font-semibold text-white leading-[1.05] tracking-[-0.04em]">
              해안의 맛을 느끼다
            </h2>
          </div>
