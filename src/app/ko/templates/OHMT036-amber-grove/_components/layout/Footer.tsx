      ...
      <div className="mx-auto px-4 pb-10 pt-14 sm:px-6 lg:px-14 lg:pt-20">
        <div className="grid grid-cols-12 gap-y-6 border-b border-white/12 pb-8 sm:gap-x-10 lg:gap-x-16 lg:items-center">
          <div className="col-span-12 lg:col-span-7">
            <h2 className="copy-heading max-w-2xl font-[family-name:var(--font-heading)] text-xl font-semibold leading-[var(--leading-body)] sm:text-3xl">
              이번 주에 수확한
              <br className="hidden sm:block" /> 과일 상자를 확인해보세요.
            </h2>
        ...
        <div className="flex flex-col gap-4 pt-5 text-sm text-[var(--color-text-muted-contrast)] sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-5">
            <Link href={`${base}/shop`} className="hover:text-white">과일 상자</Link>
            <Link href={`${base}/about`} className="hover:text-white">과수원 소개</Link>
            <Link href={`${base}/journal`} className="hover:text-white">농장일지</Link>
            <Link href={`${base}/visit`} className="hover:text-white">방문 안내</Link>
          </div>
