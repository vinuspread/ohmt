        ...
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-3xl mx-auto px-8 py-16">
            <div className="mb-12">
              ...
              <h1 className="text-4xl font-bold text-[var(--color-text)] leading-[var(--leading-heading)] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                문서 워크스페이스
              </h1>
            ...
            <p className="text-center text-[11px] leading-relaxed text-[var(--color-text-muted)] py-6">이 페이지는 실제 고객사나 운영 중인 업체가 아닌 OHMT의 웹사이트 디자인 템플릿 데모입니다. 표시된 브랜드명, 인물, 후기, 연락처와 성과 수치는 예시 콘텐츠입니다.</p>
          </div>
        </main>
      </div>
    </div>
