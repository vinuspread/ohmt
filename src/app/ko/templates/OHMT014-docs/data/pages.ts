...
export const docPages: DocPage[] = [
  {
    ...
    content: [
      ...
      { type: "text", value: "이 문서 템플릿은 지식을 정리하고 기록할 수 있는 깔끔한 공간을 선보입니다. 팀의 두뇌라고 생각하세요. 체계적이고 검색 가능하며 항상 최신 상태로 유지됩니다." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "quote", value: "잘 정리된 문서는 깔끔한 책상과 같습니다. 모든 것이 제자리에 있어 놓치는 것이 없습니다." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", value: "팁: @멘션으로 특정 팀원에게 알리세요. 멘션된 팀원은 정확한 위치로 연결된 알림을 받습니다." },
      { type: "heading", value: "댓글 & 토론", variant: "h3" },
      { type: "text", value: "텍스트를 선택하고 댓글 아이콘을 클릭해 토론을 시작하세요. 댓글은 스레드로 이어지며, 서식 있는 텍스트, 멘션, 이모지 반응을 지원합니다." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "text", value: "설정 > 연동에서 원하는 서비스의 '연결'을 클릭하세요. OAuth 인증 후에는 /embed 명령어로 콘텐츠를 바로 삽입할 수 있습니다." },
      { type: "quote", value: "연동은 문서를 정적인 지식 베이스에서 운영 전체를 위한 살아있는 컨트롤 센터로 변화시킵니다." },
      { type: "heading", value: "접근 권한 관리", variant: "h3" },
      { type: "text", value: "연동 대시보드에서 연결된 서비스를 정기적으로 점검하세요. 워크스페이스 관리자는 연결한 사람과 사용 중인 권한, 마지막 동기화 시각을 확인할 수 있습니다. 더 이상 쓰지 않는 도구는 즉시 연결을 해제하세요." },
      { type: "callout", value: "서비스를 연결하기 전에 원본 콘텐츠의 공유 범위가 워크스페이스 권한과 맞는지 확인하세요. 임베드 콘텐츠의 보안 수준은 원본 서비스의 설정을 따릅니다." },
    ],
  },
  {
    slug: "templates",
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", value: "백업을 켠 뒤에는 시험 복원을 한 번 진행하세요. 팀이 실제 복구 방법을 알고 있어야 백업 준비가 끝난 것입니다." },
      { type: "heading", value: "내보내기 전 확인사항", variant: "h3" },
      { type: "text", value: "워크스페이스를 내보내기 전에 연결된 페이지와 비공개 첨부파일, 데이터베이스 보기를 점검하세요. 용량이 큰 파일은 백그라운드에서 준비되며 완료되면 소유자에게 안전한 다운로드 링크가 전달됩니다." },
