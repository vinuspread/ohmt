...
const news = [
  ...
  {
    tag: "테크놀로지",
    title: "OHMT 2026: 역사상 가장 파격적이고 기술적으로 진화한 스마트 모빌리티 라인업",
    date: "2026년 4월 28일",
           ...
           {news.map((item) => (
             <div key={item.title} className="bg-black group">
               ...
               <div className="p-8">
                 ...
                 <h3 className="text-base font-semibold leading-[1.1] mb-3 text-white break-keep line-clamp-2 min-h-[3.25rem]">
                   {item.title}
                 </h3>
