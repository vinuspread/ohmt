...
const values = [
  { num: "01", title: "끝없는 정밀함", desc: "모든 부품은 대부분의 제조사가 불가능하다고 여기는 공차로 설계됩니다. 우리는 그것을 기본으로 여깁니다." },
  { num: "02", title: "정직한 디자인", desc: "시각적 노이즈를 위해 선을 추가하지 않습니다. 모든 곡선은 공기역학적 목적을 가지며, 모든 표면은 그 존재 가치를 증명합니다." },
  { num: "03", title: "기본이 되는 지속가능성", desc: "단순한 기능이 아닙니다. 체크리스트가 아닙니다. 지속가능성은 모든 소재 결정과 모든 공급망 선택에 내재되어 있습니다." },
  { num: "04", title: "드라이버 퍼스트", desc: "자율 주행 기능을 갖추되, 기본값으로 자율적이지 않습니다. 운전자는 여전히 차량에서 가장 중요한 시스템입니다." },
];
      ...
      <main className="antialiased bg-black text-white selection:bg-[var(--theme-accent)] selection:text-black">
        ...
        <section className="relative h-[85vh] min-h-[560px] overflow-hidden flex items-end">
          ...
          <div className="relative max-w-[var(--theme-container)] mx-auto px-5 md:px-[var(--theme-gutter)] pb-8 md:pb-12 w-full">
            ...
            <h1 className="font-[family-name:var(--theme-font-heading)] text-[clamp(2.8rem,6vw,5.5rem)] font-bold tracking-[-0.03em] leading-[1.08] max-w-[680px]">
        ...
        <section className="border-b border-[var(--theme-border)]">
          <div className="max-w-[var(--theme-container)] mx-auto px-5 md:px-[var(--theme-gutter)] py-10 md:py-14 grid md:grid-cols-2 gap-10 md:gap-20 items-center">
            <p className="text-[clamp(1.2rem,2.2vw,1.55rem)] text-white font-normal leading-[1.5] break-keep">
              2018년 설립된 OHMT Motors는 영감을 주는 차량을 만들기 위해 시작되었습니다. 단순한 이동 수단이 아닌, 첨단 기술과 타협 없는 디자인이 만나는 욕망의 대상입니다.
            </p>
            <p className="text-[1.02rem] text-white/50 leading-[1.6] font-normal break-keep">
              현재 우리는 3개 대륙에서 12,000명 이상의 직원을 고용하며, 전 세계 200개 이상의 쇼룸 네트워크를 운영하고 있습니다. 지속 가능한 럭셔리에 대한 약속이 모든 결정을 움직입니다. 우리는 단순히 자동차를 만드는 것이 아닙니다. 우리는 개인 이동의 미래를 구축합니다.
            </p>
          </div>
        </section>
        ...
        <div className="relative h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-[clamp(1.2rem,3vw,2.2rem)] font-bold tracking-tight text-white text-center max-w-[560px] px-6 leading-tight">
              "성능과 책임이 반대 개념이라는 것을 거부하는 운전자를 위해 우리는 차를 만듭니다."
            </p>
          </div>
        </div>
        ...
        <section className="max-w-[var(--theme-container)] mx-auto px-6 md:px-[var(--theme-gutter)] py-12 md:py-20">
          <div className="flex items-end justify-between mb-10 border-b border-[var(--theme-border)] pb-6">
            <h2 className="text-[clamp(1.8rem,4vw,3rem)] font-bold tracking-[-0.03em]">우리의 원칙</h2>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/65 flex flex-col items-center justify-center text-center px-6">
            ...
            <h2 className="text-[clamp(2rem,5vw,4rem)] font-bold tracking-[-0.03em] mb-8">직접 경험해보세요.</h2>
            <Link
