const specCategories = [
  ...
  { category: "기술", specs: [
    ...
    { label: "무선 업데이트", value: "무선 자동 업데이트" },
  ...
  return (
    <section className="bg-[var(--light-bg)]">
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 py-24 md:py-32">
        <h2 className="font-michroma text-[length:var(--text-h2)] text-[var(--text-on-light)] leading-[var(--leading-heading)] tracking-[-0.03em] mb-16">
          상세 사양
        </h2>
