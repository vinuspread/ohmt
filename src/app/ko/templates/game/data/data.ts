...
export const games: Game[] = [
  {
    ...
    releaseYear: 2024,
    status: "released",
    cover: "/templates/game/game-cover-01.jpg",
    rating: 9.2,
    desc: "삶과 죽음의 경계에 있는 세계를 배경으로 한 오픈월드 다크 판타지 RPG. 고대 룬이 현실을 재구성하는 힘을 지닌 파괴된 대지를 넘어 운명을 개척하세요.",
    screenshots: [
      "/templates/game/screenshot-01.jpg",
      "/templates/game/screenshot-03.jpg",
      "/templates/game/screenshot-05.jpg",
    ],
  },
  {
    id: "neon-vengeance",
    ...
    releaseYear: 2025,
    status: "released",
    cover: "/templates/game/game-cover-02.jpg",
    rating: 8.7,
    desc: "네온으로 물든 대도시에서 부패한 메가코퍼레이션을 무너뜨리기 위해 증강된 군인이 되어 싸우는 하이옥탄 사이버펑크 FPS.",
    screenshots: [
      "/templates/game/screenshot-02.jpg",
      "/templates/game/screenshot-04.jpg",
      "/templates/game/screenshot-06.jpg",
    ],
  },
  {
    id: "verdant-fall",
    ...
    releaseYear: 2025,
    status: "early-access",
    cover: "/templates/game/game-cover-03.jpg",
    rating: 8.9,
  ...
  },
  {
    ...
    releaseYear: 2026,
    status: "upcoming",
    cover: "/templates/game/game-cover-04.jpg",
    rating: 0,
  ...
  },
  {
    ...
    releaseYear: 2026,
    status: "upcoming",
    cover: "/templates/game/game-cover-05.jpg",
    rating: 0,
...
export const news: NewsItem[] = [
  {
    ...
    title: "Oh My Template, 새로운 게임 엔진 기술 공개",
    category: "기술",
    date: "2026년 6월 12일",
