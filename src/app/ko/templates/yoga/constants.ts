...
export const NAV_ITEMS = [
  { label: "홈", href: "/ko/templates/OHMT022-yoga-KO" },
  { label: "클래스", href: "/ko/templates/OHMT022-yoga-KO/classes" },
  { label: "소개", href: "/ko/templates/OHMT022-yoga-KO/about" },
  { label: "예약", href: "/ko/templates/OHMT022-yoga-KO/schedule" },
  { label: "마이페이지", href: "/ko/templates/OHMT022-yoga-KO/mypage" },
] as const;
