...
const PANELS = [
  { image: "/templates/yoga/class-vinyasa.jpg", label: "비니아사 플로우", sub: "다이나믹 무브먼트", href: "/ko/templates/yoga/classes/vinyasa-flow" },
  { image: "/templates/yoga/class-hatha.jpg", label: "하타 요가", sub: "고요함과 호흡", href: "/ko/templates/yoga/classes/hatha-yoga" },
  { image: "/templates/yoga/class-meditation.jpg", label: "명상", sub: "내면의 고요", href: "/ko/templates/yoga/classes/meditation" },
  { image: "/templates/yoga/class-pilates.jpg", label: "필라테스", sub: "코어 & 정렬", href: "/ko/templates/yoga/classes/pilates" },
];
