    ...
    <TemplateWrapper theme={theme}>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
            ...
            {currentItems.map((product, i) => (
              ...
              >
                ...
                <div className="space-y-3 px-2">
                  ...
                  <p className="text-xs text-black/70 line-clamp-2 font-sans leading-relaxed">{product.desc}</p>
        ...
        {totalPages > 1 && (
          <div className="mt-40 flex items-center justify-center gap-12 border-t border-black/10 pt-20">
            <button 
              ...
              className={`flex items-center gap-2 text-[13px] uppercase tracking-widest font-bold transition-[opacity,transform] ${currentPage === 1 ? 'opacity-20 cursor-not-allowed' : 'hover:-translate-x-2'}`}
            >
            ...
            <button 
              ...
              className={`flex items-center gap-2 text-[13px] uppercase tracking-widest font-bold transition-[opacity,transform] ${currentPage === totalPages ? 'opacity-20 cursor-not-allowed' : 'hover:translate-x-2'}`}
            >
        ...
        >
          ...
          <Link href="/ko/templates/OHMT021-museum-KO/collections" className="group flex items-center gap-4 text-xs uppercase tracking-[0.4em] font-bold bg-black text-white px-10 py-6 hover:bg-[var(--color-bg-secondary)] transition-colors">
