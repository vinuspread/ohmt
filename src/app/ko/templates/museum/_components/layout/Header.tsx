...
const LIGHT_BG_ROUTES = [
  "/ko/templates/OHMT021-museum-KO/souvenir",
  "/ko/templates/OHMT021-museum-KO/sacred-vatican",
  "/ko/templates/OHMT021-museum-KO/curator-note",
];
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-8 text-[13px] tracking-tight font-bold hidden md:flex w-1/3">
          <Link
            href="/ko/templates/OHMT021-museum-KO/exhibitions"
          ...
          <Link
            href="/ko/templates/OHMT021-museum-KO/our-story"
            className="hover:opacity-50 transition-opacity underline-offset-8 hover:underline"
          >
            {"미술관 안내"}
          </Link>
