    ...
    <TemplateWrapper theme={theme}>
      ...
      <div className="w-full h-auto flex flex-col md:flex-row relative">
        ...
        <div className="w-full md:w-1/2 md:h-screen md:sticky md:top-0 p-6 md:p-12 lg:p-20 flex flex-col justify-center bg-[var(--color-primary)]">
          <Link href="/ko/templates/OHMT021-museum-KO/collections" className="inline-flex items-center gap-2 text-[13px] uppercase tracking-normal text-white/40 hover:text-white transition-colors mb-8 w-fit">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif mb-8 leading-[1.5] tracking-tighter">
              {artwork.title}
            </h1>
            ...
            <p className="text-base leading-relaxed text-white/70 font-normal max-w-xl mb-8">
              {artwork.description}
            </p>

            {/* Audio Player UX */}
            <div className="group flex items-center gap-4 p-4 border border-white/10 hover:border-white/30 hover:bg-white/5 transition-colors cursor-pointer w-full max-w-sm">
               <div className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-colors duration-500 shrink-0">
                  <Headphones size={14} />
               </div>
