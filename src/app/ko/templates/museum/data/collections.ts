...
export const collections: CollectionItem[] = [
  { 
    ...
    year: 'c. 30 BC',
    img: "/templates/museum/laocoon-sculpture.png", 
    images: ["/templates/museum/laocoon-sculpture.png", "/templates/museum/laocoon-detail-1.png", "/templates/museum/laocoon-detail-2.png"],
    tag: "Sculpture",
    category: "Sculpture",
  ...
  { 
    ...
    artist: "Raphael",
    year: '1509–1511',
    img: "/templates/museum/school-of-athens.png", 
    images: ["/templates/museum/school-of-athens.png"],
    tag: "Fresco",
    category: "Fresco",
  ...
  { 
    ...
    artist: "Michelangelo",
    year: '1508–1512',
    img: "/templates/museum/creation-of-adam.png", 
    images: ["/templates/museum/creation-of-adam.png"],
    tag: "Fresco",
    category: "Fresco",
  ...
  { 
    ...
    artist: "Michelangelo",
    year: '1498–1499',
    img: "/templates/museum/pieta-sculpture.png", 
    images: ["/templates/museum/pieta-sculpture.png"],
    tag: "Marble",
    category: "Marble",
  ...
  { 
    ...
    artist: "Leochares",
    year: 'c. 120-140 AD',
    img: "/templates/museum/apollo-belvedere.png", 
    tag: "Sculpture",
    category: "Sculpture",
  ...
  { 
    ...
    artist: "Raphael",
    year: '1516–1520',
    img: "/templates/museum/transfiguration.png", 
    tag: "Fresco",
    category: "Fresco",
  ...
  ...Array.from({ length: 15 }).map((_, i) => ({
    ...
    year: "Early Century",
    img: i % 2 === 0 ? "/templates/museum/hero-bg.png" : "/templates/museum/curator.png",
