// src/app/ko/templates/airline/page.tsx
"use client";
          ...
          <div className="max-w-[1320px] mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
              <div>
                ...
                <Link href="/ko/templates/airline/experience" className="inline-flex items-center gap-3 text-[0.72rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-primary)] hover:translate-x-1.5 transition-transform duration-300">
        ...
        <section className="py-16 md:py-24 bg-[var(--color-bg-secondary)]">
          <div className="max-w-[1320px] mx-auto px-6 md:px-10">
            ...
            <div className="mt-10 md:mt-14 text-center">
              <Link
                href="/ko/templates/airline/experience"
