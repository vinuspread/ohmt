        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "전체 상품", href: "/ko/templates/sneaker/shop-all" },
                { label: "신상품", href: "/ko/templates/sneaker/shop-all" },
                { label: "베스트셀러", href: "/ko/templates/sneaker/shop-all" },
                { label: "세일", href: "/ko/templates/sneaker/shop-all" },
              ].map(l => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "스니커즈", href: "/ko/templates/sneaker/shop-all" },
                { label: "러닝", href: "/ko/templates/sneaker/shop-all" },
                { label: "포멀", href: "/ko/templates/sneaker/shop-all" },
                { label: "부츠", href: "/ko/templates/sneaker/shop-all" },
                { label: "로퍼", href: "/ko/templates/sneaker/shop-all" },
              ].map(l => (
                <li key={l.label}><Link href={l.href} className="text-[0.85rem] text-white/70 hover:text-white transition-colors">{l.label}</Link></li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "사이즈 가이드", href: "/ko/templates/sneaker/shop-all" },
                { label: "배송 안내", href: "/ko/templates/sneaker/shop-all" },
                { label: "교환/반품", href: "/ko/templates/sneaker/shop-all" },
                { label: "문의하기", href: "/ko/templates/sneaker/contact" },
              ].map(l => (
                <li key={l.label}><Link href={l.href} className="text-[0.85rem] text-white/70 hover:text-white transition-colors">{l.label}</Link></li>
              ))}
            </ul>
