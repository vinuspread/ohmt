// src/app/ko/templates/OHMT005-sneaker-KO/-components/layout/Header.tsx
"use client";
...
export const Header = () => {
  ...
  const navLinks = [
    { label: "카테고리", href: "/ko/templates/OHMT005-sneaker-KO/shop-all" },
    { label: "숍", href: "/ko/templates/OHMT005-sneaker-KO/shop-all" },
    { label: "어바웃", href: "/ko/templates/OHMT005-sneaker-KO/about" },
    { label: "블로그", href: "/ko/templates/OHMT005-sneaker-KO/blog" },
    { label: "문의", href: "/ko/templates/OHMT005-sneaker-KO/contact" },
  ];
    ...
    <>
      <header className={`fixed top-0 left-0 w-full h-14 md:h-20 z-50 transition-[background,border-color] duration-300 flex items-center bg-white ${scrolled ? "border-b border-black/10" : ""}`}>
        <div className="max-w-[1440px] mx-auto w-full px-6 flex items-center justify-between gap-8">
          <Link href={`/ko/templates/OHMT005-sneaker-KO`} className="text-[1.2rem] md:text-[1.4rem] font-black tracking-[-0.04em] text-black uppercase shrink-0">
            Vinuspread
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href={`/ko/templates/OHMT005-sneaker-KO/cart`} className="relative flex w-8 h-8 items-center justify-center text-black/70 hover:text-black transition-colors">
              <ShoppingBag size={18} />
            </Link>
