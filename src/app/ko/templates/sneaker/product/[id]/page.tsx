      ...
      <div className="bg-white text-black selection:bg-black selection:text-white font-sans">
        ...
        <main className="antialiased pt-20">
          ...
          <div className="max-w-[1440px] mx-auto px-6 py-4 border-b border-black/10">
            <Link href="/ko/templates/OHMT005-sneaker/shop-all" className="inline-flex items-center gap-2 text-[0.78rem] text-black/50 hover:text-black transition-colors">
          ...
          <div className="border-t border-black/10 py-16">
            <div className="max-w-[1440px] mx-auto px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {related.map(p => (
                  <Link key={p.id} href={`/ko/templates/OHMT005-sneaker/product/${p.id}`} className="group block border border-black/10 hover:border-black transition-colors">
