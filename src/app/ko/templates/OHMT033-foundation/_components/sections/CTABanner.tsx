        ...
        <div className="py-12 md:pb-12 md:pl-12 md:pt-24">
          ...
          <form className="mt-6 flex max-w-[520px] flex-col gap-3 sm:flex-row">
            ...
            <input
              ...
              style={{ height: 48 }}
            />
            <ActionButton type="submit" className="h-12 bg-[var(--color-primary)] px-6 text-white hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white">
              참여 문의
            </ActionButton>
          </form>
        </div>
