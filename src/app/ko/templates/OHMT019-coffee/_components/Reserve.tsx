      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        >
          <div className="shrink-0">
            ...
            <h2 className="font-heading text-xl md:text-2xl font-light text-white leading-snug">
              좋은 커피는 좋은 소식에서 시작합니다.
            </h2>
          </div>
          ...
          <div className="flex gap-0 w-full md:max-w-[480px]">
            <input
              ...
              className="flex-1 bg-white/8 border border-white/15 text-white placeholder-white/30 px-5 py-3 text-xs focus:outline-none focus:border-white/40 min-w-0"
            />
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
              <button className="bg-white text-[var(--color-primary-dark)] px-6 py-3 text-xs uppercase tracking-[0.18em] font-bold whitespace-nowrap hover:bg-white/90 transition-colors duration-200 h-full">
                구독하기
              </button>
            </motion.div>
          </div>
