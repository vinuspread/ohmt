      ...
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 pb-12 border-b border-white/10">
          ...
          <div className="flex flex-col sm:flex-row gap-10 lg:gap-16 text-sm font-[family-name:var(--font-body)]">
            <div>
              <p className="text-[0.65rem] uppercase tracking-[0.2em] text-white/40 mb-3">문의</p>
              <a
              ...
              <p className="text-white/40 mt-1 text-sm">미국 오스틴 · 전 세계 촬영</p>
            </div>
            <div>
              <p className="text-[0.65rem] uppercase tracking-[0.2em] text-white/40 mb-3">소셜</p>
