    ...
    >
      ...
      {!showSidebar && (
        <button
          ...
          className="fixed right-0 top-1/2 -translate-y-1/2 bg-pink-500 text-white p-2 rounded-l-xl z-[100011] hover:pr-4 transition-all"
        >
      ...
      {tempPin && (
        ...
        >
          ...
          <div className="flex gap-2 mt-4">
            <button
              onClick={handleAdd}
              className="flex-1 bg-pink-500 text-white py-4 rounded-2xl text-sm font-black uppercase hover:bg-pink-400 transition-all active:scale-[0.98]"
            >
              Add Command
            </button>
          </div>
