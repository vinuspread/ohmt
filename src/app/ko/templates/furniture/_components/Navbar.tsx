    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto w-full px-6 md:px-12 flex items-center justify-between">
          {/* Logo */}
          <Link href="/ko/templates/OHMT004-furniture-KO" className="text-xl md:text-2xl font-black lowercase text-[var(--color-text)]">
            Oh My Template
          </Link>

          {/* Desktop Menu */}
          <div className="hidden md:flex items-center gap-10 text-[13px] font-medium text-[var(--color-secondary)]">
            <Link href="/ko/templates/OHMT004-furniture-KO/category/living" className="hover:text-[var(--color-primary)] transition-colors uppercase">{"리빙룸"}</Link>
            <Link href="/ko/templates/OHMT004-furniture-KO/category/bedroom" className="hover:text-[var(--color-primary)] transition-colors uppercase">{"침실"}</Link>
            <Link href="/ko/templates/OHMT004-furniture-KO/category/dining" className="hover:text-[var(--color-primary)] transition-colors uppercase">{"다이닝"}</Link>
            <Link href="/ko/templates/OHMT004-furniture-KO/category/workspace" className="hover:text-[var(--color-primary)] transition-colors uppercase">{"워크스페이스"}</Link>
          </div>
          ...
          <div className="flex items-center gap-6 text-[var(--color-text)]">
            ...
            <Link href="/ko/templates/OHMT004-furniture-KO/cart" className="relative hover:text-[var(--color-primary)] transition-colors">
      ...
      >
        <div className="flex flex-col px-6 text-[14px] font-medium text-[var(--color-secondary)]">
          ...
          <div className="flex flex-col gap-1 border-b border-black/5 pb-4 mb-4">
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO/category/living" 
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO/category/bedroom" 
              onClick={() => setMobileOpen(false)}
              className="hover:text-[var(--color-primary)] py-2 transition-colors uppercase"
            >
              {"침실"}
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO/category/dining" 
              onClick={() => setMobileOpen(false)}
              className="hover:text-[var(--color-primary)] py-2 transition-colors uppercase"
            >
              {"다이닝"}
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO/category/workspace" 
              onClick={() => setMobileOpen(false)}
              className="hover:text-[var(--color-primary)] py-2 transition-colors uppercase"
            >
              {"워크스페이스"}
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO/cart" 
              onClick={() => setMobileOpen(false)}
            ...
            <Link 
              href="/ko/templates/OHMT004-furniture-KO" 
              onClick={() => setMobileOpen(false)}
              className="hover:text-[var(--color-primary)] py-2 transition-colors uppercase"
            >
              {"계정 / 로그인"}
