// src/app/ko/templates/car/-components/layout/Header.tsx
"use client";
    ...
    <>
      <nav className={clsx(
        ...
        <div className="max-w-[var(--theme-container)] mx-auto px-6 md:px-[var(--theme-gutter)] flex items-center justify-between w-full">
          <Link href="/ko/templates/car" className="text-[0.95rem] font-bold tracking-[0.25em] uppercase text-white">
