            ...
            <div className="flex flex-col lg:w-2/5">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  ...
                  <Button
                    variant="primary"
                    onClick={() => router.push('/ko/templates/OHMT001-fashion/cart')}
          ...
          <section className="mt-16 md:mt-24 pb-12 border-t border-black/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="pt-4">
                  <Link href="/ko/templates/OHMT001-fashion" className="text-[13px] font-bold uppercase tracking-[0.25em] border-b border-black pb-1 hover:opacity-50 transition-opacity">
                    컬렉션으로 돌아가기
                  </Link>
                </div>
              </motion.div>
