...
const menuGroups = [
  {
    label: '메인',
    items: [
      { label: '대시보드', href: '/ko/templates/dashboard', icon: LayoutDashboard },
      { label: '분석', href: '/ko/templates/dashboard/analytics', icon: TrendingUp },
      { label: '리포트', href: '/ko/templates/dashboard/reports', icon: FileText },
    ],
  },
  {
    label: '관리',
    items: [
      { label: '주문', href: '/ko/templates/dashboard/orders', icon: ShoppingCart },
      { label: '고객', href: '/ko/templates/dashboard/customers', icon: Users },
      { label: '캘린더', href: '/ko/templates/dashboard/calendar', icon: Calendar },
    ],
  },
  {
    label: '계정',
    items: [
      { label: '설정', href: '/ko/templates/dashboard/settings', icon: Settings },
      { label: '프로필', href: '/ko/templates/dashboard/profile', icon: UserCircle },
    ],
  },
]
