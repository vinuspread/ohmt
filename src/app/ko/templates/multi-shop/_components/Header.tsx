...
export const Header = () => {
  ...
  const navLinks = [
    { name: "홈", href: "/ko/templates/multi-shop" },
    { name: "쇼핑", href: "/ko/templates/multi-shop/shop" },
    { name: "스토리", href: "/ko/templates/multi-shop/about" },
    { name: "매거진", href: "/ko/templates/multi-shop/blog" },
    { name: "문의", href: "/ko/templates/multi-shop/contact" },
  ];

  const isHome = pathname === "/ko/templates/multi-shop";
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between h-16 md:h-18">
          ...
          >
            {navLinks.map((link) => {
              const isActive =
                pathname === link.href ||
                (link.href !== "/ko/templates/multi-shop" &&
