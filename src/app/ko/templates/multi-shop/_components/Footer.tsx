      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-16 pb-8 md:pt-20 md:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-8">
          <div className="col-span-2 md:col-span-2">
            <Link href="/ko/templates/OHMT017-multi-shop-KO" className="text-2xl font-bold tracking-tight text-white">
              Oh My Template
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "신상품", href: "/ko/templates/OHMT017-multi-shop-KO/shop" },
                { label: "베스트셀러", href: "/ko/templates/OHMT017-multi-shop-KO/shop" },
                { label: "액세서리", href: "/ko/templates/OHMT017-multi-shop-KO/shop/accessories" },
                { label: "신발", href: "/ko/templates/OHMT017-multi-shop-KO/shop/footwear" },
                { label: "여성", href: "/ko/templates/OHMT017-multi-shop-KO/shop/womens" },
                { label: "남성", href: "/ko/templates/OHMT017-multi-shop-KO/shop/mens" },
              ].map((l) => (
                <li key={l.label}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "스토리", href: "/ko/templates/OHMT017-multi-shop-KO/about" },
                { label: "매거진", href: "/ko/templates/OHMT017-multi-shop-KO/blog" },
                { label: "문의하기", href: "/ko/templates/OHMT017-multi-shop-KO/contact" },
              ].map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="hover:text-white transition-colors duration-200">{l.label}</Link>
                </li>
