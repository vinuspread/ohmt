            ...
            <div className="grid md:grid-cols-2 gap-12">
              {content.articles.map((article, i) => (
                <motion.article
                  ...
                  className="pb-8 border-b border-[#DDD] group"
                >
                  <Link href={`/ko/templates/newspaper/${category}/${article.slug}`}>
                    <img
                  ...
                  <h2 className="font-[family-name:var(--theme-font-heading)] text-[1.3rem] font-bold leading-snug mb-3 group-hover:text-[var(--color-primary)] transition-colors tracking-[-0.03em]">
                    <Link href={`/ko/templates/newspaper/${category}/${article.slug}`}>{article.title}</Link>
                  </h2>
