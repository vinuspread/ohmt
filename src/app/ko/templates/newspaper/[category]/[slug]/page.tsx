...
function renderContent(content: string) {
  return content.trim().split('\n').map((line, idx) => {
    if (line.startsWith('## ')) {
      return <h2 key={idx} className="font-[family-name:var(--theme-font-heading)] text-xl font-bold mt-10 mb-4 text-black border-l-4 border-[var(--color-primary)] pl-4 tracking-[-0.03em]">{line.replace('## ', '')}</h2>;
    }
    if (line.trim()) {
      return <p key={idx} className="text-[1rem] text-[#444] leading-[1.9] mb-5 font-sans">{line}</p>;
    }
    return null;
  });
}
          ...
          <div className="flex flex-col lg:flex-row gap-12 py-10">
            ...
            <article className="flex-1 min-w-0">
              ...
              <div className="border-t-2 border-black mt-14 pt-8 pb-16 flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-[0.82rem] text-[#555] leading-relaxed font-sans">
            ...
            <aside className="lg:w-[300px] xl:w-[320px] shrink-0 space-y-10">
              ...
              <div className="bg-[var(--color-primary)] p-6 text-white">
                ...
                <h4 className="font-[family-name:var(--theme-font-heading)] text-[1.3rem] font-bold leading-tight mb-3 tracking-[-0.03em]">
