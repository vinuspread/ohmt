      ...
      >
        <div className="md:pr-8 md:border-r border-[var(--color-border)]">
          ...
          <img
            ...
            alt="Hero story"
          />
          <h1 className="font-[family-name:var(--theme-font-heading)] text-[clamp(1.25rem,1.8vw,1.75rem)] font-bold leading-[1.1] mb-4 group tracking-[-0.01em]">
          ...
          <p className="text-[0.92rem] text-[#555] font-sans leading-[1.8] mb-4">
                         OHMT TIMES는 표면 아래에 숨겨진 구조적 본질을 정확하게 짚어내고, 타협 없는 사실 관계 증명을 통해 우리 시대를 선명하게 기록하는 신뢰받는 지식 아카이브입니다.
          </p>
        ...
        <div className="md:pl-8 flex flex-col gap-8">
          <div className="border-b border-[var(--color-border)] pb-6">
            <h3 className="font-[family-name:var(--theme-font-heading)] text-[1.05rem] font-bold leading-[1.1] mb-2 text-black tracking-[-0.01em]">
              <Link href={`${base}/science/arctic-current-patterns`} className="hover:text-[var(--color-primary)]">북극 해류 패턴 변화를 암시하는 새로운 증거 발견.</Link>
            </h3>
            <p className="text-[0.85rem] text-[#555] leading-[1.7]">극지 연구소, 해수 온도 상승에 대한 '경고성' 데이터 분석 결과 발표.</p>
          </div>
          <div className="border-b border-[var(--color-border)] pb-6">
            <h3 className="font-[family-name:var(--theme-font-heading)] text-[1.05rem] font-bold leading-[1.1] mb-2 text-black tracking-[-0.01em]">
              <Link href={`${base}/politics/eastern-elections`} className="hover:text-[var(--color-primary)]">동부 선거: 지정학적 분수령에 선 정치적 기로.</Link>
            </h3>
            <p className="text-[0.85rem] text-[#555] leading-[1.7]">급진적 제도 개혁 요구의 물결 속에 투표율 사상 최고치 경신.</p>
          </div>
          <div>
            <h3 className="font-[family-name:var(--theme-font-heading)] text-[1.05rem] font-bold leading-[1.1] mb-2 text-black tracking-[-0.01em]">
              <Link href={`${base}/tech/antitrust-scrutiny`} className="hover:text-[var(--color-primary)]">빅테크 기업들, 브뤼셀에서 새로운 반독점 규제 직면.</Link>
            </h3>
      ...
      >
        {[
          ...
          <div key={i} className="px-6 border-r border-[var(--color-border)] first:pl-0 last:pr-0 last:border-r-0">
            ...
            <h3 className="font-[family-name:var(--theme-font-heading)] text-[1.15rem] font-bold leading-[1.1] mb-2 text-black tracking-[-0.01em]">
