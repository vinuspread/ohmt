...
export const navLinks: NavLink[] = [
  { label: "홈", href: "/ko/templates/spa" },
  { label: "소개", href: "/ko/templates/spa/about" },
  { label: "서비스", href: "/ko/templates/spa/service" },
  { label: "가격", href: "/ko/templates/spa/pricing" },
  { label: "테라피스트", href: "/ko/templates/spa/therapists" },
  { label: "블로그", href: "/ko/templates/spa/blog" },
  { label: "문의", href: "/ko/templates/spa/contact" },
];
