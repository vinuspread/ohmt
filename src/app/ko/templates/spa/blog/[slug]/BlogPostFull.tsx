      ...
      <>
        ...
        <main className="pt-24 min-h-screen bg-[var(--color-bg)] flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/ko/templates/spa/blog" className="mt-4 inline-flex text-sm text-[var(--color-primary)] hover:underline">블로그로 돌아가기</Link>
          </div>
        </main>
        <Footer />
      </>
        ...
        <article className="py-24 lg:py-32 bg-[var(--color-bg)]">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <motion.div initial={reduce ? { opacity: 0 } : { opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25, ease: EASE_OUT }} className="mt-12 space-y-6 text-[0.95rem] text-[var(--color-text-muted)] leading-relaxed">
              ...
              <div className="pt-6"><a href="/ko/templates/spa/contact" className="inline-flex items-center rounded-full bg-[var(--color-primary)] text-[var(--color-text-contrast)] px-6 py-2.5 text-sm font-semibold hover:brightness-110 active:scale-[0.97] transition-all duration-150">상담 예약하기</a></div>
            </motion.div>
            <div className="mt-16 pt-8 border-t border-[var(--color-border)]"><Link href="/ko/templates/spa/blog" className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--color-primary)] hover:underline">← 블로그로 돌아가기</Link></div>
          </div>
        </article>
      </main>
      <Footer />
