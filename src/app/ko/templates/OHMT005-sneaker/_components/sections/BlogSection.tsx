...
const posts = [
  { title: "출근부터 주말까지, 스니커즈 활용법", category: "스타일", date: "2026년 5월 20일" },
  { title: "지속 가능한 신발을 고르는 기준", category: "지속 가능성", date: "2026년 5월 14일" },
  { title: "스니커즈를 오래 신는 관리법", category: "관리", date: "2026년 5월 8일" },
  { title: "2026 스니커즈 트렌드", category: "트렌드", date: "2026년 5월 1일" },
];
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {posts.map((p, i) => (
            <Link key={slugs[i]} href={`/ko/templates/OHMT005-sneaker/blog`} className="group block">
              ...
              <h3 className="text-[0.9rem] font-bold text-black leading-[var(--leading-heading)] mb-3 group-hover:opacity-60 transition-opacity tracking-[-0.03em]">{p.title}</h3>
