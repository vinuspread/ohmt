    ...
    <section className="relative overflow-hidden bg-black text-white py-12 md:py-24">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div className="max-w-2xl">
          <span className="text-[0.7rem] font-bold uppercase tracking-[0.25em] text-white/60 block mb-3">기간 한정</span>
          <h2 className="text-[length:var(--text-h2)] font-black tracking-[-0.03em] uppercase leading-[var(--leading-heading)] mb-6">
            주말 한정 할인
          </h2>
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8 text-white/80">
            <div className="flex items-center gap-2">
              <span className="text-[0.85rem] opacity-75">결제 단계에서 할인 코드를 입력하세요.</span>
            ...
            <p className="text-[0.85rem] opacity-75">전 상품 20% 할인 · 일요일 자정 종료</p>
          </div>
