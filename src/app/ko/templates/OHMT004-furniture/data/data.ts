...
export const products = [
  ...
  },
  {
    ...
    longDesc: "거대한 조각상 같은 묵직하고 정돈된 안식을 위해 완성한 벨벳 모노 소파는 낮고 깊은 시트 포지션으로 최상의 안락함을 선보입니다. 가마에서 건조해 수축율을 낮춘 애쉬 원목 내부 프레임에 고밀도 복원 폼과 최고급 구스다운 패딩을 레이어링하여 오래 사용해도 풍성한 쿠션감을 유지합니다. 벨기에산 고중량 천연 린넨 패브릭은 몸에 달라붙지 않고 보송보송한 촉감을 선사하며, 숨겨진 블록 다리 덕분에 거실 공간을 모던하고 넓어 보이게 연출합니다.\n\n이 소파는 넓은 팔걸이(Armrest) 디자인을 지니고 있어 찻잔이나 스마트폰, 책을 안전하게 얹어두는 간이 테이블 역할을 겸할 수 있습니다. 내부에는 특수 완성한 S자 강선 스프링 구조와 이중 코일 서스펜션 시스템을 적용해 착석 시 하중을 이상적으로 분산시킵니다.\n\n린넨 커버는 완전히 탈부착하여 드라이클리닝할 수 있어 장기간 쾌적하게 사용이 가능합니다.",
    details: {
  ...
  },
  {
    ...
    longDesc: "좁은 원룸이나 세련된 서재의 미니멀 데스크 역할을 수행하는 벽걸이형 플로팅 데스크입니다. 단단한 천연 오크 원목 상판에 정밀 레이저 컷팅한 무광 분체도장 블랙 스틸 월 프레임을 결합해 뛰어난 안전성을 선보입니다. 슬림하게 숨겨진 서랍에는 부드럽게 닫히는 소프트 클로징 하이 댐퍼 러너가 탑재되어, 노트북이나 각종 서류를 정갈하고 조용하게 수납할 수 있습니다.\n\n이 벽걸이형 책상은 하부에 다리가 없어 의자 이동이 자유로우며, 데스크 하부에는 멀티탭과 케이블 선을 완벽하게 숨길 수 있는 통합 배선 관리 덕트(Duct)를 설계하여 극도의 정돈감을 추구합니다.\n\n상판 양옆에는 필기구나 조명을 흔들림 없이 고정할 수 있는 전용 홈 슬롯 처리가 가미되어 있습니다.",
    details: {
