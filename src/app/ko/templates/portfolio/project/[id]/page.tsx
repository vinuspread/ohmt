        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col md:flex-row min-h-screen pt-16">
            ...
            <div className="md:w-[420px] lg:w-[480px] shrink-0 md:sticky md:top-16 md:h-[calc(100vh-4rem)] flex flex-col justify-between px-8 md:px-10 py-16">
              <div>
                <Link href="/ko/templates/portfolio"
                ...
                >
                  ...
                  <p className="text-[0.9rem] text-[#5a6271] leading-relaxed mb-12">{project.description}</p>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-baseline justify-between py-4 border-b border-[#eef0f6]">
                    <span className="text-[13px] font-medium uppercase tracking-widest text-[#8a919b]">라이브 프로젝트</span>
              ...
              <div className="mt-8">
                <Link href="/ko/templates/portfolio/contact"
                  ...
                  비슷한 프로젝트 시작 <ArrowUpRight size={11} />
                </Link>
              </div>
            </div>
        ...
        <section className="py-12 md:py-24 border-t border-[#eef0f6]">
          <div className="max-w-[1440px] mx-auto px-8 md:px-10">
            <div className="flex items-end justify-between mb-14">
              <h2 className="text-[clamp(1.5rem,3vw,2rem)] font-black uppercase tracking-tighter">더 많은 작업</h2>
              <Link href="/ko/templates/portfolio"
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {others.map((p, i) => (
                ...
                >
                  <Link href={`/ko/templates/portfolio/project/${p.id}`} className="group block">
