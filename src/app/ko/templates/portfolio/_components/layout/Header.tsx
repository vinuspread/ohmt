...
const koNav = [
  { num: '_01', name: 'Works', href: '/ko/templates/portfolio' },
  { num: '_02', name: 'About', href: '/ko/templates/portfolio/about' },
  { num: '_03', name: 'Journal', href: '/ko/templates/portfolio/journal' },
  { num: '_04', name: 'Contact', href: '/ko/templates/portfolio/contact' },
];
    ...
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md' : 'bg-transparent'}`}>
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
          {/* Logo mark */}
          <Link href={`/ko/templates/portfolio`} className="text-[1.2rem] font-black tracking-tighter text-[var(--color-text)] hover:opacity-60 transition-opacity">
            Oh My Template.
          </Link>
