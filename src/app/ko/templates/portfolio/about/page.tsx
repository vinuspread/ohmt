        ...
        <section className="pt-40 pb-14 md:pb-28 border-b border-[var(--color-border)]">
          <div className="max-w-[1440px] mx-auto px-6 grid md:grid-cols-2 gap-20 items-end">
            ...
            <div className="space-y-6">
              ...
              <Link href="/ko/templates/portfolio/contact" className="inline-flex items-center gap-2 text-[13px] font-bold uppercase tracking-widest text-[var(--color-text)] border-b border-[var(--color-accent)]/30 pb-0.5 hover:border-[var(--color-accent)] transition-colors">
