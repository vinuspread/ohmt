          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-16 md:gap-24 lg:gap-32 items-start mb-32">
              <div>
                ...
                <div className="space-y-5 text-[0.95rem] text-black/60 leading-loose break-keep">
                  <p>
                    VELURE는 하나의 근본적인 질문에서 출발했습니다. 럭셔리 스킨케어가 투명성을 포기하지 않아도 될까? 우리는 이 브랜드로 그 답을 증명하기로 했습니다. 효과적이면서도 정직한 포뮬러로 말입니다.
                  </p>
                  <p>
