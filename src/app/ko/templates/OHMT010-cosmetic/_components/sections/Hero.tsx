// src/app/ko/templates/OHMT010-cosmetic/-components/sections/Hero.tsx
"use client";
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row justify-between items-center py-12 mt-20 gap-16">
          <div className="flex-1 max-w-[860px]">
            <h1 className="text-2xl md:text-6xl font-normal leading-[var(--leading-heading)] mb-12 break-keep">
