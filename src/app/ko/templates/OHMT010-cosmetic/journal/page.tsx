...
const entries = [
  {
    ...
    content: "비타민 C는 스킨케어에서 가장 강력한 항산화 성분 중 하나입니다. 활성산소를 억제하고 콜라겐 합성을 촉진하며 맑은 안색을 선사하는 효능 덕분에 필수적인 원료로 꼽힙니다. 피부 장벽을 안전하고 효과적으로 통과하는 메종의 안정화 공법을 경험해보세요."
  },
  {
  ...
  },
  {
    ...
    content: "모든 보태니컬 원료 뒤에는 자연과 공존하고자 하는 메종의 단단한 서사가 담겨 있습니다. 우리는 공정무역과 유기농 지속 가능한 농법을 준수하는 농부들과 파트너십을 맺어 원료를 수급합니다. 우리의 선택이 글로벌 생태계에 미치는 선한 영향력을 경험해보세요."
  }
];
