          ...
          <div className="flex items-center gap-6">
            ...
            >
              <div className="w-5 h-4 relative">
                <motion.span className="absolute left-0 top-0 w-full h-[2px] bg-white block origin-center" animate={menuOpen ? { rotate: 45, y: 7 } : { rotate: 0, y: 0 }} transition={{ duration: 0.3, ease: easeOut }} />
                <motion.span className="absolute left-0 top-1/2 -translate-y-1/2 w-full h-[2px] bg-white block" animate={menuOpen ? { opacity: 0 } : { opacity: 1 }} transition={{ duration: 0.2 }} />
                <motion.span className="absolute left-0 bottom-0 w-full h-[2px] bg-white block origin-center" animate={menuOpen ? { rotate: -45, y: -7 } : { rotate: 0, y: 0 }} transition={{ duration: 0.3, ease: easeOut }} />
              </div>
            </button>
          </div>
        </div>
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="hidden md:block absolute bottom-12 right-12 text-right">
              ...
              <p className="text-sm font-body text-white/60 mb-4">info@vantagallery.com · +1 (212) 555-0147</p>
