...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Magazine - Oh My Template",
    description: "Editorial culture and lifestyle",
    url: "https://ohmytemplate.com/ko/templates/magazine",
  ...
  alternates: {
    canonical: "https://ohmytemplate.com/ko/templates/magazine",
    languages: { "en": "https://ohmytemplate.com/en/templates/magazine" },
  },
};
