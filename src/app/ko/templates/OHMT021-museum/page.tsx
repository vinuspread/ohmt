    ...
    <TemplateWrapper theme={theme}>
      ...
      <section className="py-6 md:py-16 bg-[var(--color-accent)] text-[var(--color-primary)]">
        ...
        >
          <div className="flex-1 text-center md:text-left">
            <span className="text-xs md:text-xs uppercase font-bold tracking-[0.5em] text-black/40 block mb-2 md:mb-4">{"경험의 깊이를 더하다"}</span>
            ...
            <p className="text-black/60 font-normal max-w-xs md:max-w-md text-sm md:text-sm leading-relaxed">
              {"세계적인 미술 사학자들의 해설과 함께 바티칸의 위대한 유산을 한층 깊이 있게 경험해보세요. 다국어 오디오 가이드를 지원합니다."}
            </p>
          </div>
      ...
      <section ref={horizontalRef} className="relative bg-[var(--color-primary)]" style={{ height: "auto" }}>
        <div className="sticky top-0 min-h-screen flex flex-col justify-center overflow-hidden py-6 md:py-16 lg:pt-16">
          ...
          <div className="px-4 md:px-12 lg:px-24 mb-3 md:mb-8 lg:mb-12">
            <span className="text-xs md:text-xs uppercase font-bold tracking-[0.5em] text-white/40 block mb-2 md:mb-4">{"컬렉션 01"}</span>
      ...
      <section className="py-8 md:py-20 lg:py-28 bg-[var(--color-accent)] text-[var(--color-primary)]">
        <div className="max-w-[1440px] mx-auto px-6 grid md:grid-cols-2 gap-6 md:gap-16 items-center">
          ...
          >
            <span className="text-xs md:text-xs uppercase font-bold tracking-[0.5em] text-black/40 mb-4 md:mb-6 block">{"에디토리얼"}</span>
             <h3 className="text-4xl md:text-7xl font-serif font-bold mb-4 md:mb-10 leading-[var(--leading-heading)] tracking-[-0.03em]">{"신성한 비례"}</h3>
