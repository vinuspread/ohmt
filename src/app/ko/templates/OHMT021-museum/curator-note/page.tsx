  ...
  return (
    ...
    <TemplateWrapper theme={theme}>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <span className="text-xs uppercase font-bold tracking-[0.5em] text-black/40 block mb-6">{"에디토리얼"}</span>
          <h1 className="text-5xl md:text-8xl font-serif leading-[var(--leading-heading)] tracking-tighter break-keep">{"신성한 비례"}</h1>
        </motion.div>
        ...
        >
          ...
          <p className="mt-8 break-keep">
            {"라파엘로가 남긴 붓 터치 하나, 미켈랑젤로의 망치 아래 스러져간 대리석 조각 하나까지, 이 모든 것은 박제된 과거의 유산이 아닙니다. 인간성과 고통, 지식과 신성을 둘러싸고 인류가 끊임없이 이어가는 대화입니다."}
          </p>
