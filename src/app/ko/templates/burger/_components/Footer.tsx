      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-16 pb-8 md:pt-20 md:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link href="/ko/templates/burger" className="text-xl font-bold tracking-tight text-white">
              Oh My Template
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/ko/templates/burger/menu" className="text-sm text-white/60 hover:text-white transition-colors">버거</Link>
              <Link href="/ko/templates/burger/menu" className="text-sm text-white/60 hover:text-white transition-colors">치킨</Link>
              <Link href="/ko/templates/burger/menu" className="text-sm text-white/60 hover:text-white transition-colors">사이드</Link>
              <Link href="/ko/templates/burger/menu" className="text-sm text-white/60 hover:text-white transition-colors">쉐이크</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/ko/templates/burger/about" className="text-sm text-white/60 hover:text-white transition-colors">소개</Link>
              <Link href="/ko/templates/burger/locations" className="text-sm text-white/60 hover:text-white transition-colors">매장</Link>
