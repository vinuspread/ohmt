...
export const Header = () => {
  ...
  const navLinks = [
    { name: "메뉴", href: "/ko/templates/burger/menu" },
    { name: "소개", href: "/ko/templates/burger/about" },
    { name: "매장", href: "/ko/templates/burger/locations" },
  ];

  const isHome = pathname === "/ko/templates/burger";
              ...
              return (
                <div key={link.href} className="relative group py-4">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 top-full hidden group-hover:block bg-white text-black shadow-lg py-2 w-40 border border-neutral-100">
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">세트 메뉴</Link>
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">버거</Link>
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">치킨</Link>
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">사이드</Link>
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">디저트</Link>
                    <Link href="/ko/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">음료</Link>
                  </div>
                </div>
              );
            }
