const solutions = [
  {
    ...
    image: "/templates/fitness/program-recovery.jpg",
  },
  {
    title: "스트렝스",
    desc: "모든 신체를 위한 정밀한 근력 운동 — 초보자부터 엘리트 선수까지.",
    image: "/templates/fitness/program-strength.jpg",
  },
  {
    title: "밸런스",
    desc: "큐레이션된 무브먼트 시퀀스와 브레스워크를 통한 몸과 마음의 조화.",
    image: "/templates/fitness/program-mobility.jpg",
  },
  {
    title: "릴렉세이션",
    desc: "조용하고 프라이빗한 스튜디오 환경에서의 심층 이완 테크닉.",
    image: "/templates/fitness/cta-bg.jpg",
  },
];
