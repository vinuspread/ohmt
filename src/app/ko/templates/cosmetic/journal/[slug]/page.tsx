      ...
      <TemplateWrapper theme={theme}>
        <main className="antialiased bg-[var(--color-bg)] text-black">
          ...
          <div className="pt-16 md:pt-32 pb-20 text-center">
            ...
            <Link href="/ko/templates/OHMT020-cosmetic-kr/journal" className="text-[var(--color-accent)] mt-4 inline-block">
              Back to Journal
            </Link>
          </div>
          <Footer />
      ...
      <main className="antialiased bg-[var(--color-bg)] text-black selection:bg-black selection:text-white">
        ...
        <section className="pt-16 md:pt-32 pb-16">
          <div className="max-w-[1440px] mx-auto px-6 md:px-10">
            <Link href="/ko/templates/OHMT020-cosmetic-kr/journal" className="inline-flex items-center gap-2 text-[0.8rem] font-bold uppercase tracking-wider text-black/60 hover:text-black transition-colors mb-8">
              <ArrowLeft size={14} />
              Back to Journal
            </Link>
            ...
            <div className="mt-20 pt-16 border-t border-black/10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {entries.filter(e => e.slug !== article.slug).slice(0, 2).map((related) => (
                  <Link key={related.slug} href={`/ko/templates/OHMT020-cosmetic-kr/journal/${related.slug}`}>
