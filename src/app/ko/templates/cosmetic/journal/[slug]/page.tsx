      ...
      <TemplateWrapper theme={theme}>
        <main className="antialiased bg-[var(--color-bg)] text-black">
          ...
          <div className="pt-16 md:pt-32 pb-20 text-center">
            ...
            <Link href="/ko/templates/OHMT010-cosmetic-KO/journal" className="text-[var(--color-accent)] mt-4 inline-block">
              Back to Journal
            </Link>
          </div>
          <Footer />
      ...
      <main className="antialiased bg-[var(--color-bg)] text-black selection:bg-black selection:text-white">
        ...
        <section className="pt-16 md:pt-32 pb-16">
          <div className="max-w-[1440px] mx-auto px-6 md:px-10">
            <Link href="/ko/templates/OHMT010-cosmetic-KO/journal" className="inline-flex items-center gap-2 text-[0.8rem] font-bold uppercase tracking-wider text-black/60 hover:text-black transition-colors mb-8">
              <ArrowLeft size={14} />
              Back to Journal
            </Link>

            <div className="space-y-6">
              <h1 className="text-[clamp(2rem,5vw,3.5rem)] font-normal tracking-tight leading-[1.5]">
                {article.title}
              </h1>
              ...
              <div className="border-t border-black/10 pt-6">
                <p className="text-[1.05rem] text-black/70 leading-relaxed max-w-[1440px]">
                  {article.excerpt}
                </p>
              </div>
            </div>
          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-10">
            <article className="prose prose-sm max-w-none">
              {article.content.split('\n\n').map((paragraph, idx) => {
                ...
                return (
                  <p key={idx} className="text-[1rem] text-black/70 leading-[1.8] mb-6">
                    {paragraph}
                  </p>
                );
              })}
            ...
            <div className="mt-20 pt-16 border-t border-black/10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {entries.filter(e => e.slug !== article.slug).slice(0, 2).map((related) => (
                  <Link key={related.slug} href={`/ko/templates/OHMT010-cosmetic-KO/journal/${related.slug}`}>
                    <div className="p-6 bg-white hover: transition-shadow cursor-pointer rounded-sm border border-black/5">
