const milestones = [
  { year: "2018", title: "창립", desc: "강남에 첫 플래그십 스튜디오를 열었습니다." },
  { year: "2019", title: "첫 위탁 운영", desc: "종로 5성급 호텔의 웰니스 시설 운영을 맡았습니다." },
  { year: "2021", title: "5개 지점", desc: "호텔, 레지던스, 기업 캠퍼스로 운영 범위를 넓혔습니다." },
  { year: "2023", title: "Vitalis Academy", desc: "트레이너 교육과 내부 인증 과정을 정식화했습니다." },
  { year: "2026", title: "12개 파트너", desc: "연 3,200명 이상의 회원이 프로그램을 이용합니다." },
];
