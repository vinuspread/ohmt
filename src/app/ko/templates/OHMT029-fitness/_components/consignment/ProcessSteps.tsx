const steps = [
  {
    number: "01",
    title: "컨설팅",
    desc: "비전과 공간, 목표를 깊이 분석해 성공 기준을 함께 정의합니다.",
  },
  {
    number: "02",
    title: "디자인",
  ...
  },
  {
    number: "03",
    title: "스태핑",
    desc: "Vitalis Academy에서 팀을 채용·교육·인증해 첫날부터 한결같은 품질을 보장합니다.",
  },
  {
    number: "04",
    title: "운영 관리",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <div key={step.number} className="relative">
              <p className="font-['Montserrat'] text-5xl font-bold text-[var(--accent-soft)] leading-none mb-4">{step.number}</p>
              <h3 className="font-['Montserrat'] font-semibold text-lg text-[var(--text)] mb-3">{step.title}</h3>
