  ...
  return (
    <section className="bg-[var(--bg)] py-24 md:py-32">
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12">
        <p className="text-xs font-medium text-[var(--text-muted)] tracking-[0.15em] uppercase mb-2 text-center">파트너</p>
        ...
        <p className="text-sm text-[var(--text-muted)] text-center max-w-[460px] mx-auto mb-16 leading-relaxed">
          프리미엄 호텔 및 리조트와 협력하여&nbsp;<span className="whitespace-nowrap">월드클래스</span>&nbsp;웰니스 경험을 선보입니다.
        </p>
