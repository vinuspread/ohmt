...
const statsCards = [
  { label: '세션', value: '284,500', change: '+12.3%', icon: TrendingUp, color: 'var(--color-primary)' },
  { label: '방문자', value: '142,300', change: '+8.7%', icon: Users, color: 'var(--color-success)' },
  { label: '이탈률', value: '38.4%', change: '-2.1%', icon: MousePointerClick, color: 'var(--color-warning)' },
  { label: '평균 체류 시간', value: '4분 32초', change: '+5.4%', icon: Clock, color: 'var(--color-info)' },
]
...
const trafficSources = [
  { name: '오가닉', value: 42, color: 'var(--color-primary)' },
  { name: '직접', value: 28, color: 'var(--color-success)' },
  { name: '소셜', value: 18, color: 'var(--color-info)' },
  { name: '추천', value: 12, color: 'var(--color-warning)' },
]
...
const devices = [
  { name: '데스크탑', percentage: 58, color: 'var(--color-primary)' },
  { name: '모바일', percentage: 34, color: 'var(--color-success)' },
  { name: '태블릿', percentage: 8, color: 'var(--color-info)' },
]
    ...
    <DashboardLayout title="분석">
      ...
      >
        ...
        <div className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]">
          <h3 className="text-base font-[var(--font-heading)] font-semibold text-[var(--color-text)] mb-4">트래픽 개요</h3>
        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-5">
            <motion.div
              ...
              className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]"
            >
              <h3 className="text-base font-[var(--font-heading)] font-semibold text-[var(--color-text)] mb-4">트래픽 소스</h3>
          ...
          <div className="col-span-7">
            <motion.div
              ...
              className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]"
            >
              <h3 className="text-base font-[var(--font-heading)] font-semibold text-[var(--color-text)] mb-4">상위 페이지</h3>
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--color-border)]">
                    <th className="text-left text-[11px] uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">페이지 URL</th>
                    <th className="text-right text-[11px] uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">조회수</th>
                    <th className="text-right text-[11px] uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">이탈률</th>
                  </tr>
                </thead>
                <tbody>
                  {topPages.map((page, i) => (
        ...
        <motion.div
          ...
          className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]"
        >
          <h3 className="text-base font-[var(--font-heading)] font-semibold text-[var(--color-text)] mb-4">기기별 현황</h3>
