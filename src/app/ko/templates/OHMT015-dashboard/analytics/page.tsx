              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--color-border)]">
                    <th className="text-left text-xs uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">페이지 URL</th>
                    <th className="text-right text-xs uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">조회수</th>
                    <th className="text-right text-xs uppercase tracking-[0.08em] text-[var(--color-text-muted)] font-medium px-3 py-2.5">이탈률</th>
                  </tr>
                </thead>
                <tbody>
                  {topPages.map((page, i) => (
