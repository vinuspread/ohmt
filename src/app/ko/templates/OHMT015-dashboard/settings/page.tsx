  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 py-3 border-b border-[var(--color-border)] last:border-0">
      <div className="min-w-0 flex-1">
        ...
        <p className="text-sm text-[var(--color-text-muted)] mt-0.5">생성일 {created}</p>
      </div>
      <div className="flex items-center gap-1">
        ...
        >
          {copied ? <span className="text-xs text-[var(--color-success)]">복사됨</span> : <Copy size={14} strokeWidth={1.5} />}
        </button>
  ...
  switch (tab) {
    ...
    case 'notifications':
      return (
        <div className="space-y-4">
          <h4 className="text-sm font-medium text-[var(--color-text)] border-b border-[var(--color-border)] pb-2">알림 설정</h4>
    ...
    case 'security':
      return (
        <div className="space-y-5">
          <div>
            <h4 className="text-sm font-medium text-[var(--color-text)] border-b border-[var(--color-border)] pb-2 mb-4">비밀번호 변경</h4>
            <div className="space-y-4">
              <FormInput label="현재 비밀번호" type="password" value="••••••••" />
              <div>
                <label className="block text-xs font-medium text-[var(--color-text-muted)] mb-1.5">새 비밀번호</label>
              ...
              <div>
                <label className="block text-xs font-medium text-[var(--color-text-muted)] mb-1.5">새 비밀번호 확인</label>
                <div className="relative">
          ...
          <div>
            <h4 className="text-sm font-medium text-[var(--color-text)] border-b border-[var(--color-border)] pb-2 mb-4">2단계 인증</h4>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[var(--color-text)]">인증 앱으로 2FA 설정</p>
      ...
      return (
        <div>
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-sm font-medium text-[var(--color-text)]">API 키</h4>
