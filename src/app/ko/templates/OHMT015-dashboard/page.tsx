  ...
  return (
    <DashboardLayout title="Dashboard">
      <div className="space-y-3">
        ...
        <p className="text-center text-[11px] leading-relaxed text-neutral-400 py-4">이 페이지는 실제 고객사나 운영 중인 업체가 아닌 OHMT의 웹사이트 디자인 템플릿 데모입니다. 표시된 브랜드명, 인물, 후기, 연락처와 성과 수치는 예시 콘텐츠입니다.</p>
      </div>
    </DashboardLayout>
  )
}
