    ...
    <TemplateWrapper theme={theme}>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        >
          ...
          <Link href="/ko/templates/exhibition/collections" className="group flex items-center gap-4 text-xs uppercase tracking-[0.4em] font-bold bg-black text-white px-10 py-6 hover:bg-[var(--color-bg-secondary)] transition-colors">
