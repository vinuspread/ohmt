...
function MuseumInfoContent() {
  ...
  const grottoes = [
    { ...grottoesData[0], img: "/templates/exhibition/papal-tombs.png" },
    { ...grottoesData[1], img: "/templates/exhibition/curator.png" },
    { ...grottoesData[2], img: "/templates/exhibition/vatican-hallway.png" },
  ];
  ...
  return (
    ...
    <TemplateWrapper theme={theme}>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden pt-20 md:pt-0">
        ...
        >
          <img
            src="/templates/exhibition/st-peters-exterior.png"
      ...
      <section className="max-w-[1440px] mx-auto px-8 md:px-16 py-10 md:py-20 md:py-32 lg:py-40 border-b border-white/5">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="relative aspect-[4/5] overflow-hidden">
            <img loading="lazy" src="/templates/exhibition/vatican-hallway.png" alt="Museum Corridor" className="w-full h-full object-cover grayscale-[0.3] hover:scale-105 transition-transform duration-[2s]" />
          </motion.div>
        </motion.div>
      ...
      <section className="max-w-[1440px] mx-auto px-8 md:px-16 py-10 md:py-20 md:py-32 lg:py-40 border-b border-white/5">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-center mb-40">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2 }} className="aspect-[4/5] overflow-hidden">
            <img loading="lazy" src="/templates/exhibition/baldaquin.png" alt="Bernini's Baldaquin" className="w-full h-full object-cover grayscale-[0.2] hover:scale-105 transition-transform duration-[2s]" />
          </motion.div>
      ...
      <section className="py-10 md:py-20 md:py-32 lg:py-40 text-center px-6">
        ...
        <Link
          href="/ko/templates/exhibition/collections"
