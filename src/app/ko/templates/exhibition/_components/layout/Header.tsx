...
const LIGHT_BG_ROUTES = [
  "/ko/templates/exhibition/souvenir",
  "/ko/templates/exhibition/sacred-vatican",
  "/ko/templates/exhibition/curator-note",
];
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-8 text-[13px] tracking-tight font-bold hidden md:flex w-1/3">
          <Link
            href="/ko/templates/exhibition/exhibitions"
          ...
          <Link
            href="/ko/templates/exhibition/our-story"
            className="hover:opacity-50 transition-opacity underline-offset-8 hover:underline"
          >
            {"미술관 안내"}
          </Link>
