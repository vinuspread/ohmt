      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed top-0 right-0 w-full max-w-md h-full bg-white z-[101] flex flex-col"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
              {[
                { name: "Unicorn Limited Edition", price: "$4,200", img: "/templates/exhibition/gundam-unicorn.jpg", size: "M" },
                { name: "Sazabi Executive Piece", price: "$5,850", img: "/templates/exhibition/gundam-sazabi.jpg", size: "L" },
              ].map((item, i) => (
                <div key={i} className="flex gap-6 group">
                  <div className="w-24 aspect-[3/4] bg-luxury-beige overflow-hidden">
                    <img loading="lazy" src={item.img} alt={item.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
                  </div>
            ...
            <div className="p-8 bg-luxury-cream border-t border-luxury-border">
              ...
              <button className="w-full py-6 bg-luxury-black text-white text-[13px] uppercase font-bold tracking-[0.4em] flex items-center justify-center gap-4 hover:bg-opacity-90 transition-[color,background,transform] active:scale-95">
