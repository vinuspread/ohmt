    ...
    <TemplateWrapper theme={theme}>
          ...
          <div className="flex-1 grid md:grid-cols-2 gap-12 mt-12">
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <Link href="/ko/templates/exhibition/contact" className="relative overflow-hidden group inline-flex px-8 py-4 border border-black mt-10">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="flex flex-col items-start md:items-end justify-end">
              ...
              <Link href="/ko/templates/exhibition/exhibitions" className="text-[11px] font-body font-semibold uppercase tracking-[0.12em] text-black border-b border-black pb-0.5 hover:opacity-60 transition-opacity">
                전체 보기
              </Link>
            </div>
          </div>
      ...
      <section className="bg-[var(--color-bg)] py-32">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="mt-16">
            <Link href="/ko/templates/exhibition/events" className="text-[11px] font-body font-semibold uppercase tracking-[0.12em] text-black border-b border-black pb-0.5 hover:opacity-60 transition-opacity">
              전체 이벤트 보기
            </Link>
          </div>
        </div>
