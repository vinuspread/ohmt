...
export const collections: CollectionItem[] = [
  { 
    ...
    year: 'c. 30 BC',
    img: "/templates/exhibition/laocoon-sculpture.png", 
    images: ["/templates/exhibition/laocoon-sculpture.png", "/templates/exhibition/laocoon-detail-1.png", "/templates/exhibition/laocoon-detail-2.png"],
    tag: "Sculpture",
    category: "Sculpture",
  ...
  { 
    ...
    artist: "Raphael",
    year: '1509–1511',
    img: "/templates/exhibition/school-of-athens.png", 
    images: ["/templates/exhibition/school-of-athens.png"],
    tag: "Fresco",
    category: "Fresco",
  ...
  { 
    ...
    artist: "Michelangelo",
    year: '1508–1512',
    img: "/templates/exhibition/creation-of-adam.png", 
    images: ["/templates/exhibition/creation-of-adam.png"],
    tag: "Fresco",
    category: "Fresco",
  ...
  { 
    ...
    artist: "Michelangelo",
    year: '1498–1499',
    img: "/templates/exhibition/pieta-sculpture.png", 
    images: ["/templates/exhibition/pieta-sculpture.png"],
    tag: "Marble",
    category: "Marble",
  ...
  { 
    ...
    artist: "Leochares",
    year: 'c. 120-140 AD',
    img: "/templates/exhibition/apollo-belvedere.png", 
    tag: "Sculpture",
    category: "Sculpture",
  ...
  { 
    ...
    artist: "Raphael",
    year: '1516–1520',
    img: "/templates/exhibition/transfiguration.png", 
    tag: "Fresco",
    category: "Fresco",
  ...
  ...Array.from({ length: 15 }).map((_, i) => ({
    ...
    year: "Early Century",
    img: i % 2 === 0 ? "/templates/exhibition/hero-bg.png" : "/templates/exhibition/curator.png",
