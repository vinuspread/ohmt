...
const products = [
  { id: 1, name: "Unicorn Limited Edition", price: "$4,200", img: "/templates/exhibition/gundam-unicorn.jpg", category: "Nano Series" },
  { id: 2, name: "Sazabi Executive Piece", price: "$5,850", img: "/templates/exhibition/gundam-sazabi.jpg", category: "Elite" },
  { id: 3, name: "Nu-Gundam Classic", price: "$3,400", img: "/templates/exhibition/gundam-nu.jpg", category: "Icons" },
  { id: 4, name: "Project-01 Prototype", price: "$2,900", img: "/templates/exhibition/project-1.jpg", category: "Prototype" },
  { id: 5, name: "Project-02 Advanced", price: "$3,100", img: "/templates/exhibition/project-2.jpg", category: "Advanced" },
  { id: 6, name: "Project-03 Ultimate", price: "$6,500", img: "/templates/exhibition/project-3.jpg", category: "Ultimate" },
];
            ...
            >
              <div className="relative aspect-[3/4] bg-luxury-cream mb-6 overflow-hidden">
                <img 
                  src={product.img} 
                  alt={product.name}
                  className="w-full h-full object-cover grayscale-[0.3] group-hover:grayscale-0 group-hover:scale-110 transition-[filter,transform] duration-[1s]"
                />
