                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <div className="space-y-6 pt-4">
                      <label className="text-sm font-bold uppercase tracking-widest text-[#7A7A7A] block">프리미엄 객실 등급</label>
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-[#7A7A7A] leading-relaxed normal-case">
                        원하는 공간을 선택하세요. 아래 이용 가능한 좌석을 클릭하여 맞춤 특전을 확인하고 선택하세요.
                      </p>
                    </div>
                    ...
                    <div className="p-8 space-y-8 max-w-lg mx-auto bg-[var(--color-bg-secondary)] rounded-3xl">
                      <div className="text-center pb-4 border-b border-[var(--color-border)]">
                        <span className="text-sm uppercase font-bold tracking-[0.4em] text-[#7A7A7A]">A380 상부 데크 전방</span>
                      </div>
                    ...
                    {selectedSeat && (
                      ...
                      >
                        <h4 className="font-bold text-base uppercase tracking-wider text-[var(--color-accent)] mb-2">스위트 {selectedSeat.id} 하이라이트</h4>
                        <p className="text-sm text-[#7A7A7A] leading-relaxed font-normal mb-2">{selectedSeat.perk}</p>
                        <p className="text-base font-bold text-[var(--color-primary)]">객실 추가 요금: +${selectedSeat.extraPrice} USD</p>
                      </motion.div>
                    )}
                  ...
                  >
                    <div className="space-y-4 text-center">
                      ...
                      <p className="text-sm text-[#7A7A7A] max-w-md mx-auto leading-relaxed normal-case">
                        프라이빗 생추어리가 예약되었습니다. 맞춤 탑승권의 운임 요약을 확인하세요.
                      </p>
                    </div>
                    ...
                    <div className="p-8 max-w-xl mx-auto bg-[var(--color-primary)] text-white relative overflow-hidden rounded-[32px]">
                      ...
                      <div className="flex justify-between items-start border-b border-white/10 pb-6 mb-8">
                        <div>
                          <p className="text-sm uppercase tracking-[0.3em] text-[var(--color-accent)] font-bold">STRATUS 프리미엄 패스</p>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-left normal-case mb-8">
                        <div>
                          ...
                          <p className="text-sm font-bold text-white pt-1">STRATUS 고객</p>
                        </div>
                        <div>
                        ...
                        <div>
                          <p className="text-sm uppercase tracking-[0.2em] text-white/30 font-bold">생추어리</p>
                      ...
                      <div className="border-t border-dashed border-white/20 pt-6 flex flex-col sm:flex-row justify-between items-center gap-6">
                        <div className="text-left">
                          <p className="text-sm uppercase tracking-[0.2em] text-white/30 font-bold">총 운임 청구액</p>
