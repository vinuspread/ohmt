...
export const destinations: Record<string, Destination> = {
  paris: {
    ...
    iataCode: "CDG",
    tagline: "빛과 낭만의 도시",
    desc: "파리는 웅장한 대로, 세계적 수준의 요리, 상징적인 랜드마크로 모든 여행자를 매혹합니다. 황혼의 에펜탑 황금빟에서부터 몬마르트르 자갈길의 조용한 매력까지, 프랑스의 수도는 예술, 역사, 현대적 럭셜리의 비교할 수 없는 조화를 선사합니다.",
    ...
    facts: [
      ...
      { label: "비자", value: "쉼굼 비자 필요" },
    ],
    bestMonths: ["4월", "5월", "6월", "9월", "10월"],
    highlights: [
      {
        name: "에펜탑",
        desc: "샹드마르스 광장에 우둡 선 상징적인 철제 타워 — 트로카데로에서 바라보는 야경이 가장 아름답습니다.",
      ...
      {
        name: "몬마르트르",
        desc: "구불구불한 골목길, 사크레쿠르 대성당, 술 막히는 도시 전망이 펼쳐진 보헤미안 언덕 마을입니다.",
  ...
  tokyo: {
    ...
    desc: "도쿄는 놀라운 대비의 도시입니다 — 고대 사원이 네온 빛 마천루 옆에 우둡 서 있고, 고요한 정원이 세계에서 가장 분주한 기차역과 맞닿아 있습니다. 일본의 수도는 정교한 장인 정신과 최찬단 현대성이 어우러진 비할 바 없는 감각적 경험을 선사합니다.",
    ...
    highlights: [
      {
        name: "시부야 교차로",
        desc: "세계에서 가장 분주한 획단보도 — 도쿄의 전기 같은 에너지와 속도를 상징하는 살아있는 랜드마크입니다.",
        img: "/templates/OHMT008-airline/destination-2.jpg",
      },
      {
        name: "센소지 절",
        desc: "아사쿠사에 자리한 도쿄에서 가장 오래되고 중요한 불교 사원, 전통 나카미세 상포집가가 길목을 장식합니다.",
  ...
  "new-york": {
    ...
    iataCode: "JFK",
    tagline: "잠들지 않는 도시",
    desc: "뉴욕은 지구상 그 어느 곳과도 비교할 수 없는 에너지로 고동칩니다. 맨핸튼의 하늘을 찌르는 타워에서부터 브루클린의 문화적 품요까지, 이 글로벌 메트롤폴리스는 세계적 수준의 다이닝, 예술, 패션, 엔터테인먼트를 하나의 특별한 도시에서 제공합니다.",
    ...
    highlights: [
      {
        name: "센트럴 파크",
        desc: "맨핸튼 중심부에 자리한 843에이커의 조경 공원 — 뉴욕의 허파이자 녹색 오아시스입니다.",
      ...
      {
        name: "브루클린 브리지",
        desc: "맨핸튼과 브루클린을 연결하는 공학의 경이 — 일출에 걷으면 상징적인 스카이라인을 감상할 수 있습니다.",
  ...
  dubai: {
    ...
    iataCode: "DXB",
    tagline: "사막의 럭셜리",
    desc: "두바이는 최고의 도시입니다 — 가장 높은 타워, 가장 큰 쇼핑몰, 가장 호화로운 호텔. 아라비아 사막에서 숫아오른 이 빛나는 메트롤폴리스는 상업, 관광, 건축적 야망의 글로벌 허브로 변모했습니다.",
    ...
    highlights: [
      {
        name: "부르즈 할리파",
        desc: "828m 세계 최고층 건물 — 148층 전망대까지 엘리베이터로 올라가 술 막히는 전망을 감상하세요.",
        img: "/templates/OHMT008-airline/dubai-gallery.jpg",
      },
      {
        name: "두바이 마리나",
        desc: "마천루, 럭셜리 요트, 파인 다이닝, 활기차고 나이트라이프가 늘어서는 아름다운 워터프론트 지구입니다.",
        img: "/templates/OHMT008-airline/airline-book-hero.png",
      },
      {
        name: "사막 사파리",
        desc: "둥 언덕 드라이빙, 낙타 타기, 별빛 아래 전통 베두인 디너를 경험하세요 — 잊을 수 없는 추억.",
  ...
  sydney: {
    ...
    iataCode: "SYD",
    tagline: "항구의 우아함",
    desc: "시드니는 아름다운 항구, 세계적으로 유명한 오페라 하우스, 황금빟 서핑 해변으로 매령시킵니다. 호주에서 가장 상징적인 도시는 여유로운 해안가 라이프스타일과 세련된 도시 문화를 조화시켜 세계에서 가장 매려적인 여행지 중 하나로 손꼭힙니다.",
    ...
    highlights: [
      ...
      {
        name: "본다이 비치",
        desc: "호주에서 가장 유명한 해변 — 황금빟 모래, 넘실대는 파도, 활기차고 카페와 부티크가 어우러진 곳.",
        img: "/templates/OHMT008-airline/korean-cuisine.jpg",
      },
      {
        name: "블루 마운틴",
  ...
  bali: {
    ...
    iataCode: "DPS",
    tagline: "기다리는 열대 낙원",
    desc: "발리는 그 자체로 하나의 세계입니다 — 계단식 논이 정글 계곡으로 흑러내리고, 신성한 사원이 해안 절벽에 자리하며, 공기엔 향과 프랑기파니 향기가 감도다. 신들의 섬은 영적 품요로움과 자연의 아름다움이 어우러진 특별한 경험을 선사합니다.",
    ...
    highlights: [
      {
        name: "우부드 논",
        desc: "전설적인 테갈라랑 계단식 논 — 수세기 동안 언덕에 새겨진 에메랜드 빛 계단입니다.",
        img: "/templates/OHMT008-airline/destination-2.jpg",
      },
      {
        name: "타나롯 사원",
        desc: "바위 섬에 자리한 신비로운 바다 사원 — 하늘을 배경으로 실루얣이 드리우는 일몰이 가장 장관입니다.",
        img: "/templates/OHMT008-airline/airline-experience-hero.png",
      },
      {
        name: "세미냉 비치",
