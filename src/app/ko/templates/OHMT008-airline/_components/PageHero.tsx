  ...
  return (
    <section className="pt-16 md:pt-28 pb-8 md:pb-16 bg-[var(--color-primary)] relative overflow-hidden">
      ...
      <div className={`max-w-[1320px] mx-auto px-6 md:px-10 relative z-10 ${isCenter ? "text-center" : "text-left"}`}>
        ...
        <h1 className="font-[family-name:var(--theme-font-heading)] text-[length:var(--text-h2)] font-[var(--font-weight-heading)] tracking-tight text-white leading-[var(--leading-heading)] mb-8 uppercase">
          {title}
        </h1>
