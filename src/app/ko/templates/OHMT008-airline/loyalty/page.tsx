    ...
    <TemplateWrapper theme={theme}>
      <main className="antialiased bg-white text-[var(--color-text)] selection:bg-[var(--color-accent)] selection:text-[var(--color-primary)] min-h-screen">
        ...
        <PageHero
          ...
          description="STRATUS 스카이라인 클럽에 가입하세요. 초고급 스위트, 프라이빗 VIP 공항 라운지, 가속 마일리지 적립, 엘리트 수하물 우선 서비스를 누리세요."
        />
            ...
            <div className="grid lg:grid-cols-12 gap-10 md:gap-20 items-center">
              ...
              <div className="lg:col-span-7 space-y-10">
                <div className="space-y-4">
                  <span className="text-sm font-bold uppercase tracking-[0.3em] text-[var(--color-accent)]">클럽 등급</span>
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <h4 className="text-base font-black uppercase tracking-wider mt-1">{t.name} 패스</h4>
                        </div>
                      ...
                      <div className="flex justify-between items-end border-t border-black/10 pt-4">
                        <div>
                          <p className="text-xs uppercase tracking-widest opacity-45">마일 가속</p>
            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="space-y-3">
                  <label className="text-sm font-bold uppercase tracking-widest text-[#7A7A7A]">항공 경로</label>
                  <select
                    value={route}
                  ...
                  >
                    <option value="Paris">파리 CDG ({routeMiles.Paris} Mi)</option>
                    <option value="Tokyo">도쿄 NRT ({routeMiles.Tokyo} Mi)</option>
                    <option value="New York">뉴욕 JFK ({routeMiles["New York"]} Mi)</option>
                    <option value="Dubai">두바이 DXB ({routeMiles.Dubai} Mi)</option>
                  </select>
                </div>
              ...
              <div className="pt-4 flex flex-col gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#7A7A7A] normal-case leading-relaxed font-normal mt-2">
                    *마일리지 계산은 스카이라인 프리미엄 등급 지수 및 거리 매트릭스 규칙에 따라 정확하게 산출됩니다.
                  </p>
                </div>
              </div>
            </div>
