...
export default function Navbar() {
  ...
  const homeHref = "/ko/templates/OHMT022-yoga";
          ...
          {NAV_ITEMS.slice(1).map((item) => (
            <li key={item.href}>
              <Link
                ...
                className={`text-sm tracking-normal transition-colors duration-300 font-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-4 ${
                  isCurrent(item.href)
