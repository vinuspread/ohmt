    ...
    <section className="py-12 md:py-24 lg:py-36 bg-white selection:bg-black selection:text-white">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="flex justify-between items-end mb-16 md:mb-24 gap-4">
          <div>
            <h2 className="text-2xl sm:text-[3vw] font-bold tracking-[-0.04em] uppercase leading-[1.1]">신상품</h2>
          </div>
          <Link href="/ko/templates/OHMT001-fashion/collection" className="group flex items-center gap-2 text-[11px] sm:text-[12px] font-medium uppercase tracking-[-0.03em] border-b border-black/10 pb-1 hover:border-black transition-colors whitespace-nowrap">
            전체 보기
          </Link>
        </div>
