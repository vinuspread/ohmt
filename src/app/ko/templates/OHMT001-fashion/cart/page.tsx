...
function FashionCartPageContent() {
    const items = [
        { id: "1", name: "울 블레이저 V.01", price: "₩890,000", size: "M", img: "/templates/OHMT001-fashion/product-blazer.jpg" }
    ];
                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
                    <div className="flex-1 space-y-16">
                        <div className="border-b border-black pb-8 flex justify-between items-end">
                            ...
                            <span className="text-xs font-bold tracking-widest text-black/30">1개</span>
                        </div>
                                ...
                                <div className="flex-1 flex flex-col justify-between py-2">
                                    ...
                                    <div className="flex justify-between items-center text-xs font-bold tracking-[0.2em]">
                                        <div className="flex gap-8">
                                            ...
                                            <button className="border-b border-transparent pb-1 hover:border-black transition-colors">관심 상품으로 이동</button>
                                        </div>
