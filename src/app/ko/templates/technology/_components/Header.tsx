  ...
  return (
    ...
    <header className="sticky top-0 z-50 w-full bg-[var(--color-bg)]/80 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        {/* Logo */}
        <Link href="/ko/templates/OHMT032-technology-kr" className="flex items-center gap-2 group">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/ko/templates/OHMT032-technology-kr/products" className="text-base font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors duration-200">
            제품
          </Link>
          <Link href="/ko/templates/OHMT032-technology-kr/about" className="text-base font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors duration-200">
            회사 소개
          </Link>
          <Link href="/ko/templates/OHMT032-technology-kr/contact" className="text-base font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors duration-200">
            문의하기
          </Link>
        </nav>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-[100] bg-[var(--color-bg)] flex flex-col px-6 pb-12">
          ...
          <div className="flex items-center justify-between py-4 mb-8">
            <Link href="/ko/templates/OHMT032-technology-kr" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2">
          ...
          <nav className="flex flex-col gap-2 flex-1">
            {[
              { label: '제품', href: '/ko/templates/OHMT032-technology-kr/products' },
              { label: '회사 소개', href: '/ko/templates/OHMT032-technology-kr/about' },
              { label: '문의하기', href: '/ko/templates/OHMT032-technology-kr/contact' },
            ].map((item) => (
              <Link
                key={item.label}
                href={item.href}
          ...
          <div className="mt-8">
            <Link
              href="/ko/templates/OHMT032-technology-kr/contact"
              onClick={() => setMobileMenuOpen(false)}
