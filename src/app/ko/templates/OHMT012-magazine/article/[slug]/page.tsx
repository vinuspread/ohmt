  ...
  return (
    <main className="min-h-screen bg-white px-6 py-24 text-neutral-950 md:px-12">
      <div className="mx-auto max-w-4xl">
        <p className="mb-4 text-xs font-bold uppercase tracking-[0.24em] text-neutral-500">OHMT012-magazine / 상세 페이지</p>
        ...
        <Link href="/ko/templates/OHMT012-magazine" className="mt-10 inline-flex min-h-11 items-center justify-center bg-neutral-950 px-6 text-sm font-bold text-white transition-colors hover:bg-neutral-700">목록으로 돌아가기</Link>
      </div>
    </main>
  );
}
