            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-start">
              ...
              <div className="md:sticky md:top-28">
                ...
                <div className="flex items-baseline gap-3 mb-6">
                  <span className="text-2xl font-bold text-[var(--color-primary)]">{formatKRW(product.price)}</span>
                  {product.originalPrice && (
                    <span className="text-base text-[var(--color-text-muted)] line-through">{formatKRW(product.originalPrice)}</span>
                  )}
                </div>
