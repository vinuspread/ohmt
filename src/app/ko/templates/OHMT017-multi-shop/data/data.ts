...
export const products = [
  ...
  },
  {
    ...
    longDescription: '도심 속 데일리 커뮤터와 주말 여행자 모두를 위해 완성한 고밀도 유기농 코튼 캔버스 토트백입니다. 하중이 집중되는 주요 연결 부위에 정교한 X자형 강화 스티치와 이중 웹 직조 핸들을 적용하여 뛰어난 내구성을 보장합니다. 안감을 생략한 자연스러운 내부에 스마트폰이나 키를 간편하게 수납할 수 있는 슬립 포켓을 더해, 실용적인 미학과 내추럴한 감성을 완성했습니다.\n\n이 캔버스 백은 가공되지 않은 순수한 생지 코튼 질감을 고스란히 살려 내추럴하면서도 단단한 형상을 지탱합니다. 바닥 면에는 보강 판넬을 덧대어 무거운 책이나 소지품을 넣어도 아래로 처지는 현상을 대폭 완화했습니다.\n\n시간이 지날수록 사용자의 손때가 묻어 자연스럽게 에이징되는 캔버스 고유의 텍스처를 느껴보세요.',
    specs: [
