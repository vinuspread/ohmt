export const rooms = [
  {
    ...
    desc: "정성스럽게 제작된 가구와 부드러운 린넨이 조화를 이루는 디럭스 룸은 무성한 정원이 내려다보이는 고요한 휴식처를 선보입니다."
  },
  {
    id: "executive",
    name: "이그제큐티브 스위트",
...
export const services = [
  { icon: "Swimming", title: "인피니티 풀", desc: "수평선까지 이어지는 파노라마 바다 전망 속에서 힐링하는 인피니티 풀." },
  ...
  { icon: "Fitness", title: "웰니스 센터", desc: "최신 장비와 매일 진행되는 요가, 개인 트레이닝 세션을 선보입니다." },
  { icon: "Concierge", title: "컨시어지", desc: "24시간 맞춤형 컨시어지 서비스로 예약과 특별한 경험을 제안합니다." },
  { icon: "Transport", title: "프라이빗 트랜스퍼", desc: "공항 왕복 최고급 차량 서비스와 전문 셔틀을 선보입니다." }
];
