        ...
        <section className="py-20 bg-white">
          <div className="max-w-[1440px] mx-auto px-6 md:px-12 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-2xl mx-auto">
              <span className="text-xs font-semibold text-[var(--color-accent)] tracking-tight block mb-3">웰니스 & 레저</span>
              ...
              <p className="text-base text-[var(--color-text-muted)] leading-relaxed">
                럭스 헤이븐에서는 영혼에 울림을 주는 서비스를 엄선하여 제안합니다. 미쉐린 셰프의 미식 여정부터 몸과 마음을 치유하는 스파 리추얼, 맞춤형 아일랜드 투어까지 모든 순간이 온전한 평온으로 이어지도록 설계했습니다.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-12">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-6">
                ...
                <div className="pt-4">
                  <Button variant="primary" size="md" className="text-xs tracking-tight">스파 프로그램 안내 책자 다운로드</Button>
                </div>
              </div>
            </div>
          </div>
