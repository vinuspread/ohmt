// src/app/templates/OHMT011-ir/-components/sections/Hero.tsx
"use client";
    ...
    >
      ...
      <div className="relative flex-1 flex items-center px-6 md:px-10 max-w-[1280px] mx-auto w-full py-12 md:py-24">
        <div className="max-w-[760px]">
          ...
          <h1 className="text-[length:var(--text-h1)] font-normal tracking-[-0.03em] leading-[var(--leading-heading)] mb-7 break-keep">
          ...
          <p className="text-[0.88rem] text-white/50 leading-loose max-w-[540px] mb-10 font-normal">
            우리는 단기적 재무 지표를 넘어, 견고한 ESG 경영 전략을 구축해 글로벌 스탠다드에 맞는 장기 투자 가치와 사회적 책임을 성실히 수행해 나갑니다.
          </p>
