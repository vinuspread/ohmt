...
const allNews = [
  { date: "May 15, 2026", tag: "Press Release" as Tag, title: "IRG announces 3.92조 원 strategic expansion into Southeast Asian markets", excerpt: "The investment will establish three new regional headquarters and a logistics hub in Singapore over the next 18 months.", tagColor: "var(--color-dark-bg)", image: "/templates/OHMT011-ir/ir-build.jpg" },
  { date: "April 28, 2026", tag: "Financial" as Tag, title: "Q1 2026 earnings results: Record revenue of 20.44조 원, up 12% YoY", excerpt: "Strong performance across all business segments driven by robust demand in energy and infrastructure.", tagColor: "var(--color-accent)", image: "/templates/OHMT011-ir/news-financial.png" },
  ...
  { date: "February 28, 2026", tag: "Financial" as Tag, title: "IRG Board declares quarterly dividend of 주당 672원", excerpt: "The dividend is payable on March 25, 2026 to shareholders of record as of March 10, 2026.", tagColor: "var(--color-accent)", image: "/templates/OHMT011-ir/news-dividend.jpg" },
  { date: "February 14, 2026", tag: "ESG" as Tag, title: "IRG Foundation commits 2,100억 원 to STEM education initiatives globally", excerpt: "The 10-year commitment will fund scholarships, research programs, and infrastructure at 50+ universities.", tagColor: "#0D7C3E", image: "/templates/OHMT011-ir/news-stem-education.jpg" },
  { date: "January 30, 2026", tag: "Press Release" as Tag, title: "IRG closes acquisition of Atlas Energy Solutions for 5.74조 원", excerpt: "The transaction strengthens IRG's renewable energy portfolio and expands operational capacity in the Americas.", tagColor: "var(--color-dark-bg)", image: "/templates/OHMT011-ir/ir-energy.jpg" },
  { date: "January 12, 2026", tag: "Financial" as Tag, title: "Full Year 2025 results: Revenue surpasses 72.8조 원 milestone", excerpt: "Annual net income of 12.46조 원 represents a 15.2% net margin, the highest in company history.", tagColor: "var(--color-accent)", image: "/templates/OHMT011-ir/news-annual-results.jpg" },
  ...
  { date: "November 19, 2025", tag: "Press Release" as Tag, title: "IRG launches 2.1조 원 share repurchase program", excerpt: "The program authorizes the repurchase of up to 2.1조 원 of IRG common stock over the next 24 months.", tagColor: "var(--color-dark-bg)", image: "/templates/OHMT011-ir/news-share-repurchase.jpg" },
];
                  ...
                  <div className="border border-[var(--color-border)] hover:border-[var(--color-accent)] transition-all duration-300 hover: h-full flex flex-col sm:flex-row overflow-hidden bg-white">
                    ...
                    <div className="p-8 flex-1 flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="text-[0.88rem] font-bold text-[var(--color-dark-bg)] leading-[var(--leading-heading)] mb-3 group-hover:text-[var(--color-accent)] transition-colors line-clamp-2">
                          {item.title}
                        </h3>
                        <p className="text-[0.78rem] text-[#6B6B6B] leading-loose font-normal line-clamp-3">
                          {item.excerpt}
                        </p>
                      </div>
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-[0.82rem] text-[#6B6B6B] font-normal">연도 및 카테고리별로 모든 보도자료를 확인해보세요.</p>
            </div>
