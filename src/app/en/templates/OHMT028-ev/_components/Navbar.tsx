    ...
    >
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-12 lg:px-20 flex items-center justify-between h-20 gap-2">
          ...
          <div className="flex items-center gap-3 lg:gap-8">
            ...
            <button className="hidden items-center gap-2.5 bg-[var(--accent)] text-[var(--text-on-light)] px-4 py-2 md:px-5 md:py-2.5 rounded-full text-[11px] md:text-[12px] font-inter font-medium tracking-[0.04em] hover:bg-[var(--accent-dark)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--accent)] focus-visible:outline-offset-2 sm:inline-flex" aria-label="Reserve">
