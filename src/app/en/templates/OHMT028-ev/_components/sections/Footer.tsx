...
const sitemap = [
  { label: "Overview", href: "/en/templates/OHMT028-ev" },
  { label: "Specs",    href: "/en/templates/OHMT028-ev/specs" },
  { label: "Colors",   href: "/en/templates/OHMT028-ev/specs#colors" },
  { label: "Our Story",href: "/en/templates/OHMT028-ev/story" },
  { label: "Reserve",  href: "/en/templates/OHMT028-ev/order" },
];
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 pt-6 pb-10 md:pt-12 md:pb-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="hidden md:block md:w-1/3">
            <p className="font-inter text-xs font-medium tracking-[0.08em] text-[var(--text-muted)] uppercase mb-4">Explore</p>
          ...
          <div className="hidden md:block md:w-1/3">
            <p className="font-inter text-xs font-medium tracking-[0.08em] text-[var(--text-muted)] uppercase mb-4">Follow</p>
            <ul className="space-y-3">
              {socials.map((s) => (
                <li key={s.label}>
        ...
        <div className="flex flex-row items-center justify-between gap-4 pt-6 border-t border-[var(--border)]">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="font-inter text-xs text-[var(--text-muted)] hover:text-[var(--text)] transition-colors">Terms</a>
          </div>
        </div>
      </div>
    </footer>
