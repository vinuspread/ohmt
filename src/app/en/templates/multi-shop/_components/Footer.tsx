        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "New Arrivals", href: "/en/templates/multi-shop/shop" },
                { label: "Best Sellers", href: "/en/templates/multi-shop/shop" },
                { label: "Accessories", href: "/en/templates/multi-shop/shop/accessories" },
                { label: "Footwear", href: "/en/templates/multi-shop/shop/footwear" },
                { label: "Women's", href: "/en/templates/multi-shop/shop/womens" },
                { label: "Men's", href: "/en/templates/multi-shop/shop/mens" },
              ].map((l) => (
                <li key={l.label}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "About Us", href: "/en/templates/multi-shop/about" },
                { label: "Blog", href: "/en/templates/multi-shop/blog" },
                { label: "Contact", href: "/en/templates/multi-shop/contact" },
              ].map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="hover:text-white transition-colors duration-200">{l.label}</Link>
                </li>
