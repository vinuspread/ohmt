      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-16 pb-8 md:pt-20 md:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-8">
          <div className="col-span-2 md:col-span-2">
            <Link href="/en/templates/OHMT017-multi-shop-EN" className="text-2xl font-bold tracking-tight text-white">
              Oh My Template
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "New Arrivals", href: "/en/templates/OHMT017-multi-shop-EN/shop" },
                { label: "Best Sellers", href: "/en/templates/OHMT017-multi-shop-EN/shop" },
                { label: "Accessories", href: "/en/templates/OHMT017-multi-shop-EN/shop/accessories" },
                { label: "Footwear", href: "/en/templates/OHMT017-multi-shop-EN/shop/footwear" },
                { label: "Women's", href: "/en/templates/OHMT017-multi-shop-EN/shop/womens" },
                { label: "Men's", href: "/en/templates/OHMT017-multi-shop-EN/shop/mens" },
              ].map((l) => (
                <li key={l.label}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              {[
                { label: "About Us", href: "/en/templates/OHMT017-multi-shop-EN/about" },
                { label: "Blog", href: "/en/templates/OHMT017-multi-shop-EN/blog" },
                { label: "Contact", href: "/en/templates/OHMT017-multi-shop-EN/contact" },
              ].map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="hover:text-white transition-colors duration-200">{l.label}</Link>
                </li>
