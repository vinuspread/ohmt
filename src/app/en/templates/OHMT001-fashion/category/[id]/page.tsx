...
const PRODUCTS = [
  { id: 1, price: "$120.00", image: "/templates/OHMT001-fashion/wool-hat.png", name: "Wool Bucket Hat", category: "collection" },
  { id: 2, price: "$850.00", image: "/templates/OHMT001-fashion/trench-coat.png", name: "Classic Trench Coat", category: "collection" },
  { id: 3, price: "$350.00", image: "/templates/OHMT001-fashion/backpack.png", name: "Minimalist Backpack", category: "archive" },
  { id: 4, price: "$480.00", image: "/templates/OHMT001-fashion/boots.png", name: "Premium Leather Boots", category: "archive" },
  { id: 5, price: "$1,200.00", image: "/templates/OHMT001-fashion/silk-dress.png", name: "Silk Evening Dress", category: "collection" },
  { id: 6, price: "$65.00", image: "/templates/OHMT001-fashion/basic-tee.png", name: "Cotton Basic Tee", category: "collection" },
];
      ...
      <main className="min-h-screen bg-white antialiased selection:bg-black selection:text-white">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-[120px] md:pt-[160px] pb-24">
          ...
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-[28px] sm:text-[3.5vw] font-bold tracking-tighter uppercase leading-none">{items.length} Products</p>
          </div>
