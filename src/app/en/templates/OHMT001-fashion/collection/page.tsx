      ...
      <main className="min-h-screen bg-white antialiased selection:bg-black selection:text-white">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-8 md:pt-12 pb-24">
          <Link
            ...
            className="group inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-black/50 hover:text-black transition-all mb-8 md:mb-10"
          >
          ...
          <div className="mb-12 md:mb-16">
            <h1 className="text-xs font-semibold uppercase tracking-[0.18em] text-black/40 mb-2">{LABEL}</h1>
            <p
