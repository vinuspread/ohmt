      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center space-y-6 sm:space-y-8">
            ...
            >
              <h3
                className="text-[clamp(2.25rem,4vw,3.75rem)] font-light leading-[1.08] tracking-[-0.02em] text-balance"
            ...
            <motion.p
              ...
              className="text-base text-black/70 leading-[1.7] font-normal tracking-normal max-w-[50ch] normal-case"
            >
