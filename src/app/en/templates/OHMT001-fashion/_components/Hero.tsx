      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
            <button className="relative px-8 py-3.5 sm:px-12 sm:py-4.5 bg-white text-black text-xs sm:text-xs font-bold tracking-[0.3em] sm:tracking-[0.4em] overflow-hidden group" style={{ fontFamily: "'Pretendard', sans-serif" }}>
