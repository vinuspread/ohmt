      ...
      <div className="bg-white text-[#1e1e1e] font-[family-name:var(--font-inter)] selection:bg-[#1e1e1e] selection:text-black">
        ...
        <section className="pt-40 pb-14 md:pb-28 border-b border-[#eef0f6]">
          <div className="max-w-[1440px] mx-auto px-6 grid md:grid-cols-2 gap-20 items-end">
            <div>
              <span className="text-[13px] font-bold tracking-[0.4em] uppercase text-[#8a919b] block mb-6">About the Studio</span>
            ...
            <div className="space-y-6">
              <p className="text-[1rem] text-[#5a6271] leading-[1.4]">
              ...
              <Link href="/en/templates/portfolio/contact" className="inline-flex items-center gap-2 text-[13px] font-bold uppercase tracking-widest text-[#1e1e1e] border-b border-[#D4FF00]/30 pb-0.5 hover:border-[#D4FF00] transition-colors">
        ...
        <section className="py-14 md:py-28 border-b border-[#eef0f6]">
          <div className="max-w-[1440px] mx-auto px-6">
            <div className="mb-16">
              <span className="text-[13px] font-bold tracking-[0.3em] uppercase text-[#8a919b] block mb-4">How We Work</span>
            ...
            <div className="grid md:grid-cols-4 gap-0 divide-x divide-white/10 border-x border-[#eef0f6]">
              {process.map((step, i) => (
                ...
                >
                  ...
                  <p className="text-[0.82rem] text-[#8a919b] leading-[1.4]">{step.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-14 md:py-28">
          <div className="max-w-[1440px] mx-auto px-6">
            <div className="mb-16">
              <span className="text-[13px] font-bold tracking-[0.3em] uppercase text-[#8a919b] block mb-4">The People</span>
              ...
              {team.map((m, i) => (
                ...
                >
                  <div className="aspect-square overflow-hidden bg-[#f3f3f3] mb-4">
                    <img loading="lazy" src={m.img} alt={m.name} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-300 group-hover:scale-105" />
                  </div>
