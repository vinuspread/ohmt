              ...
              <AnimatePresence mode="popLayout">
                {filteredProjects.map((p, i) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <Link href={`/en/templates/portfolio/project/${p.id}`} className="group block overflow-hidden bg-[var(--color-bg-secondary)] relative border border-black/5 hover:border-black/15 transition-all">
        ...
        <section className="py-10 md:py-20 px-5 md:px-10 border-b border-[var(--color-border)]">
          <div className="max-w-[1440px] mx-auto">
            <div className="flex items-end justify-between mb-10">
              ...
              <Link href="/en/templates/portfolio/contact" className="text-[0.82rem] font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors flex items-center gap-2">
        ...
        <section className="py-10 md:py-20 px-5 md:px-10">
          <div className="max-w-[1440px] mx-auto">
            <div className="flex items-end justify-between mb-12">
              ...
              <Link href="/en/templates/portfolio/journal" className="text-[0.82rem] font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors flex items-center gap-2">
