                ...
                <ScrollReveal delay={0.1}>
                  {isSubmitted ? (
                    <div className="space-y-4 bg-[var(--color-bg-secondary)] p-8 md:p-10 border border-[var(--color-border)]">
                      <h3 className="font-heading font-normal text-3xl text-[var(--color-text)]">
                        Proposal Submitted.
                      </h3>
                      ...
                      <button
                        ...
                        className="bg-[var(--color-text)] text-white px-6 py-2.5 text-xs font-sans tracking-[0.08em] mt-4"
                      >
                        SUBMIT ANOTHER
                      </button>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="name" className="block font-sans text-xs font-semibold text-[var(--color-text)] tracking-wider uppercase">
                          NAME
                        </label>
                        <input
                          type="text"
                          ...
                          className="w-full bg-transparent border-b border-[var(--color-border)] py-3 text-sm font-sans focus:outline-none focus:border-[var(--color-text)] transition-colors placeholder:text-[var(--color-text-secondary)]/40"
                        />
                      </div>

                      {/* Email */}
                      <div className="space-y-2">
                        <label htmlFor="email" className="block font-sans text-xs font-semibold text-[var(--color-text)] tracking-wider uppercase">
                          EMAIL ADDRESS
                        </label>
                        <input
                          type="email"
                      ...
                      {/* Details */}
                      <div className="space-y-2">
                        <label htmlFor="details" className="block font-sans text-xs font-semibold text-[var(--color-text)] tracking-wider uppercase">
                          PROJECT DETAILS
                        </label>
                        <textarea
                          id="details"
                          ...
                          rows={5}
                          className="w-full bg-transparent border-b border-[var(--color-border)] py-3 text-sm font-sans focus:outline-none focus:border-[var(--color-text)] transition-colors resize-none placeholder:text-[var(--color-text-secondary)]/40"
                        />
                      </div>

                      <button
                        type="submit"
                        className="bg-[var(--color-text)] text-white px-8 py-3.5 text-xs font-sans tracking-[0.08em] hover:bg-zinc-800 transition-colors duration-300"
                      >
                        SUBMIT PROPOSAL
                      </button>
                    </form>
              ...
              <div className="lg:col-span-5 space-y-12 lg:pl-12">
                <ScrollReveal delay={0.2}>
                  <div className="space-y-4">
                    <h3 className="font-sans text-xs font-semibold text-[var(--color-text)] tracking-wider uppercase">
                      DIRECT CHANNELS
                    </h3>
