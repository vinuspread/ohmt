...
export async function generateMetadata({
  ...
  if (!product) return { title: 'OHMT - Product' }
  return {
    title: `OHMT - ${product.name}`,
      ...
      <section className="px-5 py-14 md:px-8 md:py-20">
        <div className="mx-auto grid max-w-[1440px] gap-10 md:grid-cols-2 md:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-xl font-semibold text-[var(--color-text)]">${product.price}</p>
            <p className="mt-6 max-w-[440px] text-sm leading-relaxed text-[var(--color-text-muted)]">
              {product.description}
            </p>
