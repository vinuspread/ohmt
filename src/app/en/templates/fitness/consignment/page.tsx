    ...
    <TemplateWrapper>
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden pt-20">
        <div
          ...
          style={{ backgroundImage: "url('/templates/fitness/consignment-hero.jpg')" }}
        />
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-['Montserrat'] font-bold text-[clamp(36px,5vw,64px)] text-white leading-[1.1] tracking-tight mb-4">
            Trust us with your wellness space.
          </h1>
          <p className="text-[15px] text-white/70 max-w-[450px] mx-auto leading-relaxed">
            End-to-end consignment operations for hotels, resorts, and premium properties.
          </p>
        </div>
      </section>
      <ProcessSteps />
