...
export default async function StoryDetailPage({ params }: PageProps) {
  ...
  const jsonLd = {
    ...
    description: story.excerpt,
    author: { '@type': 'Organization', name: 'OHMT Foundation' },
  }
  ...
  return (
    <article className="mx-auto max-w-[880px] px-6 py-16 md:px-12 md:py-24">
      ...
      <h1 className="font-heading mt-3 text-[length:var(--text-h1)] font-semibold leading-[var(--leading-heading)] tracking-tight text-[var(--color-text)]">
        {story.name}
      </h1>
      ...
      <div className="mt-16 border-t border-[var(--color-border)] pt-6">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-medium text-[var(--color-primary)] hover:underline"
        >
          <span>See all Foundation programs</span>
