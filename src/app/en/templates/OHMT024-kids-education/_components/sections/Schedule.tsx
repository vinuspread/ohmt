          ...
          {upcoming.map((event, idx) => (
            ...
            >
              ...
              >
                ...
                {/* Date / Time */}
                <div className="ohmt024-schedule-meta flex items-center gap-4 whitespace-nowrap text-sm font-semibold text-[var(--color-text-muted)] sm:gap-6">
                ...
                {/* Price */}
                <span
                  className="ohmt024-schedule-price whitespace-nowrap text-right text-xl font-bold sm:w-16"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {event.price}
                </span>
