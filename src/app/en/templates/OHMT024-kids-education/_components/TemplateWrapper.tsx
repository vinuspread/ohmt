...
export function TemplateWrapper({ theme, children }: { theme: KidsTheme; children: React.ReactNode }) {
  ...
  return (
    <div style={cssVariables} className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text-main)]">
      <motion.div
