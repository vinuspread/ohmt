      ...
      <div className="max-w-[1320px] mx-auto px-6 md:px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16">
          <div className="col-span-2 md:col-span-1">
            <Link href="/en/templates/OHMT015-airline-en" className="inline-block mb-5">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {["Flight Schedule", "Destinations", "Travel Requirements", "Baggage Information"].map(item => (
                <Link key={item} href="/en/templates/OHMT015-airline-en" className="text-[0.8rem] text-[var(--color-primary)]/70 hover:text-[var(--color-primary)] transition-colors">{item}</Link>
              ))}
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {["First Class", "Business Class", "Dining & Wines", "Entertainment"].map(item => (
                <Link key={item} href="/en/templates/OHMT015-airline-en/experience" className="text-[0.8rem] text-[var(--color-primary)]/70 hover:text-[var(--color-primary)] transition-colors">{item}</Link>
              ))}
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {["Member Benefits", "Earn Miles", "Spend Miles", "Our Partners"].map(item => (
                <Link key={item} href="/en/templates/OHMT015-airline-en/loyalty" className="text-[0.8rem] text-[var(--color-primary)]/70 hover:text-[var(--color-primary)] transition-colors">{item}</Link>
              ))}
            </nav>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[var(--color-primary)]/20 gap-4">
          ...
          <div className="flex gap-6 md:gap-8">
            {["Legal Notice", "Privacy Policy", "Cookie Settings"].map(item => (
              <Link key={item} href="/en/templates/OHMT015-airline-en" className="text-[0.7rem] text-[var(--color-primary)]/60 hover:text-[var(--color-primary)] uppercase tracking-widest transition-colors">{item}</Link>
            ))}
          </div>
        </div>
      </div>
