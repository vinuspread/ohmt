      ...
      <TemplateWrapper theme={theme}>
        <main className="antialiased bg-white text-[var(--color-secondary)]">
          ...
          <div className="max-w-[1280px] mx-auto px-8 py-16 md:py-32 text-center">
            ...
            <Link href={`/en/templates/newspaper/${category}`} className="text-[var(--color-primary)] hover:underline">Back to {category}</Link>
          </div>
          <Footer />
        </main>
      </TemplateWrapper>
      ...
      <main className="antialiased bg-white text-[var(--color-secondary)] selection:bg-[var(--color-primary)] selection:text-white">
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8">
          ...
          <div className="py-6 border-b border-[#EEE]">
            <Link href={`/en/templates/newspaper/${category}`} className="inline-flex items-center gap-2 text-[0.72rem] font-bold uppercase tracking-wider text-[#555] hover:text-[var(--color-primary)] transition-colors">
              ...
              {related.length > 0 && (
                <div>
                  ...
                  <div className="space-y-0">
                    {related.map(([s, a]) => (
                      <Link key={s} href={`/en/templates/newspaper/${category}/${s}`}
              ...
              <div>
                ...
                <div className="space-y-2">
                  {otherCategories.map(cat => (
                    <Link key={cat} href={`/en/templates/newspaper/${cat.toLowerCase()}`}
