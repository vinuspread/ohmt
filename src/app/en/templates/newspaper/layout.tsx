...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Newspaper - Oh My Template",
    description: "News and publishing archive",
    url: "https://ohmytemplate.com/en/templates/OHMT013-newspaper-EN",
  ...
  alternates: {
    canonical: "https://ohmytemplate.com/en/templates/OHMT013-newspaper-EN",
    languages: { "ko": "https://ohmytemplate.com/ko/templates/OHMT013-newspaper-KO" },
  },
};
