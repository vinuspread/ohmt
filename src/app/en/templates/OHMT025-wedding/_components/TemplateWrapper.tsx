...
export function TemplateWrapper({ theme, children }: { theme: WeddingTheme; children: React.ReactNode }) {
  ...
  return (
    <div style={cssVariables} className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] selection:bg-[var(--color-primary)] selection:text-[var(--color-bg)]">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
