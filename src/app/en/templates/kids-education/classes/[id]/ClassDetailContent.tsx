  ...
  if (!classItem) {
    return (
      <div className="pt-32 text-center px-6">
        <h1 className="text-4xl font-bold" style={{ fontFamily: "var(--font-heading)" }}>Class not found</h1>
              ...
              >
                ...
                <div className="mt-6 p-5 bg-white rounded-2xl border border-black/8">
                  ...
                  <div className="mt-3 pt-3 border-t border-black/8">
                    ...
                    <p className="mt-1 text-sm">{classItem.schedule}</p>
                  </div>
                </div>
              ...
              >
                ...
                />
                  ...
                  <p className="text-sm text-[var(--color-text-muted)] mt-4 leading-relaxed">
                    Your child will learn under the guidance of an experienced educator passionate about inspiring young minds.
                  </p>
                </div>
              </motion.div>
            )}
