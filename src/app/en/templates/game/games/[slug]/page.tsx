    ...
    return (
      <TemplateWrapper theme={theme}>
        ...
        <main className="flex min-h-screen flex-col items-center justify-center pt-24 pb-24">
          ...
          <Link href="/en/templates/OHMT023-game/games" className="mt-4 text-[var(--color-primary)] hover:underline">
            Back to games
          </Link>
        </main>
        <Footer />
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              >
                {game.status === "early-access" ? "Early Access" : game.status.charAt(0).toUpperCase() + game.status.slice(1)}
              </span>
              ...
              <div className="mt-8 space-y-4 border-t border-[var(--color-border)] pt-8">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[var(--color-text-muted)]">Platforms</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[var(--color-text-muted)]">Release Year</span>
                  <span className="text-sm font-semibold">{game.releaseYear}</span>
                </div>
                {game.rating > 0 && (
                  <div className="flex items-center justify-between">
          ...
          {game.screenshots.length > 0 && (
            <section className="mt-24">
              <h2 className="mb-8 font-[var(--font-heading)] text-3xl font-bold">Screenshots</h2>
