...
export const docPages: DocPage[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "heading", value: "Managing Access", variant: "h3" },
      { type: "text", value: "Review connected services regularly from the integration dashboard. Workspace admins can see who authorized each connection, which permissions it uses, and when it last synced. Disconnect tools that are no longer part of your workflow." },
      { type: "callout", value: "Before connecting a service, confirm that its sharing settings match the permissions of the destination workspace. Embedded content can only be as secure as its original source." },
    ],
  },
  {
    slug: "templates",
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", value: "Run a test restore after enabling backups. A backup strategy is complete only when your team knows how to recover the files." },
      { type: "heading", value: "Before You Export", variant: "h3" },
      { type: "text", value: "Check linked pages, private attachments, and database views before creating a workspace archive. Large exports are prepared in the background, and the owner receives a secure download link when the package is ready." },
