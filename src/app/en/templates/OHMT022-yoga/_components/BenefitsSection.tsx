    ...
    <section className="bg-[var(--color-bg)] border-b border-[var(--color-border)]">
      <div className="flex items-end justify-between px-8 md:px-14 lg:px-20 pt-16 pb-10 border-b border-[var(--color-border)]">
        ...
        <Link
          ...
          className="hidden md:inline-flex items-center gap-2 text-xs tracking-[0.15em] uppercase text-[var(--color-text)] hover:text-[var(--color-text-muted)] group transition-colors font-medium"
          style={{ fontFamily: "var(--font-body)" }}
        >
          View All
          <span className="opacity-40 group-hover:opacity-100 group-hover:translate-x-1 transition-all"><ArrowRight size={14} className="inline" /></span>
        </Link>
      </div>
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 px-8 md:px-14 lg:px-20 pb-8 md:pb-14 lg:pb-20 pt-20 bg-gradient-to-t from-black/60 via-black/20 to-transparent">
              ...
              <div className="mt-5 overflow-hidden transition-all duration-500 ease-out max-h-0 group-hover:max-h-10">
                <span
                  className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-white border-b border-white/50 pb-0.5 font-medium"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Book Class <ArrowRight size={14} className="inline" />
                </span>
              </div>
            </div>
          </Link>
