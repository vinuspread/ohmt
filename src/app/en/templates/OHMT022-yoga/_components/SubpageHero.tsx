      ...
      <div className="absolute inset-x-0 bottom-0 px-6 pb-12 md:px-14 md:pb-16 lg:px-20 lg:pb-20">
        <div className="mx-auto max-w-[1180px]">
          <div className="max-w-[48rem]">
            <p className="prana-sub-label font-medium uppercase tracking-[0.24em] text-white/65">{eyebrow}</p>
            <h1 className="prana-sub-display mt-6 max-w-[13ch] text-white">{title}</h1>
            <p className="prana-sub-body mt-6 max-w-xl leading-7 text-white/78">{description}</p>
          </div>
        </div>
      </div>
    </section>
