  ...
  return (
    <section className="relative py-28 md:py-36 overflow-hidden bg-[var(--accent)]">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-12 text-center">
        {variant === "home" ? (
          <>
            <h2 className="font-['Montserrat'] font-bold text-[length:var(--text-h2)] text-white leading-[var(--leading-heading)] tracking-tight mb-4">
              Transform your space into a premium wellness destination.
            </h2>
            <p className="text-sm text-white/70 max-w-[560px] mx-auto mb-10 leading-relaxed">
        ...
        <a
          href="/en/templates/OHMT029-fitness/consignment"
          className="inline-block border-2 border-white text-white text-xs font-semibold px-8 py-3.5 rounded-lg hover:bg-white hover:text-[var(--accent)] transition-all tracking-wide"
        >
