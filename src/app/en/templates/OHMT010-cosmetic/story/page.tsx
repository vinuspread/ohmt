...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ohmytemplate.com/en/templates/OHMT010-cosmetic/story",
    siteName: "OHMT",
          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-16 md:gap-24 lg:gap-32 items-start mb-32">
              <div>
                ...
                <div className="space-y-5 text-[0.95rem] text-black/60 leading-[var(--leading-body)]">
                  <p>
                    VELURE was founded on a radical idea: that luxury skincare shouldn&apos;t come at the cost of transparency. We set out to create a line of products that are as honest as they are effective.
                  </p>
                  <p>
              ...
              <img loading="lazy" src="/templates/OHMT010-cosmetic/cosmetic-hero-luxury.jpg" alt="Luxury cosmetic product presentation" className="w-full h-auto object-cover aspect-[3/4] mx-auto" />
            </div>
