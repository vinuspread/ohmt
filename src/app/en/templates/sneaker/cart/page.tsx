        ...
        <main className="antialiased pt-20 min-h-screen">
          <div className="max-w-[1440px] mx-auto px-6 py-10">
            <div className="flex items-center gap-4 mb-10">
              <Link href="/en/templates/OHMT005-sneaker/shop-all" className="inline-flex items-center gap-2 text-[0.78rem] text-black/50 hover:text-black transition-colors">
            ...
            {items.length === 0 ? (
              <div className="text-center py-12 md:py-24">
                <p className="text-[1.1rem] text-black/40 mb-6">Your bag is empty</p>
                <Link href="/en/templates/OHMT005-sneaker/shop-all" className="inline-flex items-center gap-2 bg-black text-white text-[0.82rem] font-bold uppercase tracking-[0.08em] px-8 py-4">
                    ...
                    <div key={item.id} className="flex gap-6 py-6">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-4 mb-2">
                          <h3 className="text-[0.9rem] font-bold">{item.name}</h3>
                ...
                <div className="bg-[var(--color-bg-secondary)] p-8 sticky top-24">
                  ...
                  <div className="space-y-3 mb-6 pb-6 border-b border-black/10">
                    ...
                    <div className="flex justify-between text-[0.85rem]">
                      ...
                      <span className="font-bold">{subtotal >= 200 ? "Free" : "$12"}</span>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <input type="text" placeholder="Promo code" className="w-full border border-black/20 px-4 py-3 text-[0.82rem] focus:outline-none focus:border-black mb-2 bg-white" />
