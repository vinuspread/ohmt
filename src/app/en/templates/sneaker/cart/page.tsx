        ...
        <main className="antialiased pt-20 min-h-screen">
          <div className="max-w-[1440px] mx-auto px-6 py-10">
            <div className="flex items-center gap-4 mb-10">
              <Link href="/en/templates/sneaker/shop-all" className="inline-flex items-center gap-2 text-[0.78rem] text-black/50 hover:text-black transition-colors">
            ...
            {items.length === 0 ? (
              <div className="text-center py-12 md:py-24">
                ...
                <Link href="/en/templates/sneaker/shop-all" className="inline-flex items-center gap-2 bg-black text-white text-[0.82rem] font-bold uppercase tracking-[0.08em] px-8 py-4">
