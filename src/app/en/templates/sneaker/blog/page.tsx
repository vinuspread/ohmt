            ...
            <div className="max-w-[1440px] mx-auto px-6">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <Link href="/en/templates/OHMT005-sneaker-EN/blog" className="inline-flex items-center gap-3 bg-black text-white text-[0.82rem] font-bold uppercase tracking-[0.08em] px-8 py-4 hover:bg-black/80 transition-colors">
          ...
          <div className="max-w-[1440px] mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
              {filtered.slice(1).map((p) => (
                <Link key={p.slug} href="/en/templates/OHMT005-sneaker-EN/blog" className="group block">
