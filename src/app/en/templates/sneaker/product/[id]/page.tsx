        ...
        <main className="antialiased pt-20">
          ...
          <div className="max-w-[1440px] mx-auto px-6 py-12 grid md:grid-cols-2 gap-12">
            ...
            <div className="sticky top-24">
              ...
              <p className="text-[0.82rem] text-black/50 leading-[1.4]">
                Premium quality footwear crafted from sustainable materials. Free shipping on orders over $200. 30-day returns.
              </p>
            </div>
          </div>
          ...
          <div className="border-t border-black/10 py-16">
            <div className="max-w-[1440px] mx-auto px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {related.map(p => (
                  <Link key={p.id} href={`/en/templates/sneaker/product/${p.id}`} className="group block border border-black/10 hover:border-black transition-colors">
