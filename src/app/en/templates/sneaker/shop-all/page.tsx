          ...
          <div className="max-w-[1440px] mx-auto px-6 py-10">
            ...
            {filtered.length === 0 ? (
              <div className="text-center py-12 md:py-24 text-black/40">
                <p className="text-[1rem]">No products in this category yet.</p>
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {filtered.map(p => (
                  <Link key={p.id} href={`/en/templates/OHMT009-sneaker-en/product/${p.id}`} className="group block border border-black/10 hover:border-black transition-colors duration-300">
                    ...
                    <div className="p-4">
                      <h3 className="text-[0.88rem] font-bold mb-1.5">{p.name}</h3>
