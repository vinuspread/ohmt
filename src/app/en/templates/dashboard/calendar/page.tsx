      ...
      >
        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-3 space-y-4">
            ...
            <div className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]">
              <h4 className="text-sm font-medium text-[var(--color-text)] mb-3">Upcoming</h4>
            ...
            <div className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]">
              <h4 className="text-sm font-medium text-[var(--color-text)] mb-3">Categories</h4>
              <div className="space-y-2">
          ...
          <div className="col-span-3">
            <AnimatePresence mode="wait">
              {selectedDate ? (
                ...
                >
                  <p className="text-sm text-[var(--color-text-muted)]">Select a date to view events</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
