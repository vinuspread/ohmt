...
const statCards = [
  { label: 'Reports', value: 142, icon: FileText, color: 'var(--color-primary)' },
  { label: 'Orders', value: 284, icon: ShoppingCart, color: 'var(--color-success)' },
  { label: 'Customers', value: 47, icon: Users, color: 'var(--color-info)' },
  { label: 'Performance', value: '94%', icon: TrendingUp, color: 'var(--color-warning)' },
]
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-4 space-y-3">
            ...
            <motion.div
              ...
              className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]"
            >
              <h3 className="text-sm font-semibold text-[var(--color-text)] mb-3">Contact</h3>
            ...
            <motion.div
              ...
              className="bg-[var(--color-bg-elevated)] rounded-[var(--radius-lg)] p-5 border border-[var(--color-border)]"
            >
              <h3 className="text-sm font-semibold text-[var(--color-text)] mb-3">Skills</h3>
          ...
          <div className="col-span-3">
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-sm font-semibold text-[var(--color-text)]">Upcoming</h3>
                <button className="text-xs text-[var(--color-primary)] hover:underline">Calendar</button>
              </div>
