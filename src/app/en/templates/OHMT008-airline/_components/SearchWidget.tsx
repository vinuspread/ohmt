      ...
      <div className="max-w-[1320px] mx-auto bg-white border border-[var(--color-border)] border-t-[3px] border-t-[var(--color-accent)]">
        ...
        <div className="md:hidden grid grid-cols-2 gap-0 border-b border-[#eee]">
          ...
          <div className="relative flex flex-col" ref={paxRef}>
            ...
            {paxOpen && (
               <div className="absolute top-full right-0 w-[280px] bg-white border border-[#eee] border-t-[3px] border-t-[var(--color-accent)] shadow-[0_16px_48px_rgba(5,21,46,0.14)] z-[600] p-6">
                ...
                <button onClick={() => setPaxOpen(false)}
                  className="w-full mt-4 py-2.5 bg-[var(--color-accent)] text-[var(--color-primary)] text-[0.7rem] font-bold uppercase tracking-[0.14em] ">
                  Done
                </button>
              </div>
            )}
           ...
           {/* SEARCH Mobile */}
           <Button variant="primary" className="col-span-2 w-full flex flex-row items-center justify-center gap-3 py-4 px-8 hover:bg-[var(--color-accent)] hover:text-[var(--color-primary)] transition-colors duration-300 group">
             <Search size={18} className="transition-transform duration-300 group-hover:scale-110" />
             <span className="text-sm font-bold uppercase tracking-[-0.02em]">Search Flights</span>
           </Button>
         </div>
