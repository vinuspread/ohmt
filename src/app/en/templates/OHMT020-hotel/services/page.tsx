          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-12 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-2xl mx-auto">
              ...
              <p className="text-base text-[var(--color-text-muted)] leading-relaxed">
                At CASSIA, we curate services that speak to the soul. From Michelin-starred culinary journeys and restorative therapies to customized local itineraries, every detail is engineered to ensure absolute tranquility.
              </p>
            </motion.div>
          </div>
        </section>
