      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-[0.1em] block mb-2">Full Name</label>
            ...
            <div>
              <label className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-[0.1em] block mb-2">Email</label>
            ...
            <div>
              <label className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-[0.1em] block mb-2">Check-In</label>
            ...
            <div>
              <label className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-[0.1em] block mb-2">Check-Out</label>
              <input type="text" placeholder="YYYY / MM / DD" className="w-full border border-[var(--color-border)] bg-transparent px-4 py-3 text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-muted)]/50 focus:outline-none focus:border-[var(--color-accent)] transition-colors" />
            </div>
            <div>
          ...
          <div className="mt-6">
            <label className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-[0.1em] block mb-2">Special Requests</label>
          ...
          <div className="mt-8 text-center">
            <Button variant="primary" size="lg" className="text-xs tracking-[0.2em] uppercase rounded-sm px-12">Send Reservation</Button>
          </div>
        </motion.div>
      </div>
    </section>
