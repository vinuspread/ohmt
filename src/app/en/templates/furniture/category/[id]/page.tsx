    ...
    <TemplateWrapper theme={themeJson}>
      ...
      <section className="pt-20 md:pt-32 lg:pt-48 pb-12 md:pb-20 lg:pb-24 border-b border-black/5">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <Link href="/en/templates/OHMT004-furniture" className="group flex items-center gap-2 text-[12px] md:text-[13px] font-bold text-[var(--color-secondary)] hover:text-black transition-colors mb-6 md:mb-12">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-6 lg:gap-8">
            {displayProducts.map((p, i) => (
              ...
              >
                <Link href={`/en/templates/OHMT004-furniture/product/${p.id}`}>
                ...
                <div className="px-1 mt-3 flex flex-col gap-1">
                  <Link href={`/en/templates/OHMT004-furniture/product/${p.id}`} className="min-w-0">
