      ...
      <main className="antialiased min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
        ...
        <section className="relative bg-[var(--color-bg-dark)] h-[350px] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6 pt-16">
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-white/50 mb-3">Locations</p>
        ...
        <section className="py-20 bg-[var(--color-bg)] border-t border-[var(--color-border)]">
          <div className="max-w-[800px] mx-auto px-6">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-[0.25em] text-[var(--color-text-muted)] mb-3">Partnership</p>
              <h2 className="text-3xl font-bold font-heading mb-4 text-[var(--color-text)]">Franchise Inquiry</h2>
              <p className="text-sm text-[var(--color-text-muted)]">We invite partners to create a unique coffee culture with the SLOW DROP brand.</p>
            </div>
            <form onSubmit={(e) => { e.preventDefault(); alert("Inquiry submitted successfully! A representative will contact you soon."); }} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs uppercase tracking-wider font-semibold text-[var(--color-text-muted)] mb-2">Name / Company</label>
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider font-semibold text-[var(--color-text-muted)] mb-2">Phone Number</label>
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider font-semibold text-[var(--color-text-muted)] mb-2">Email Address</label>
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider font-semibold text-[var(--color-text-muted)] mb-2">Preferred Location & Budget</label>
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider font-semibold text-[var(--color-text-muted)] mb-2">Message</label>
