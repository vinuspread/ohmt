...
export const menuItems = [
  ...
  { id: '6',  name: 'Signature Latte',       category: 'coffee'    as MenuCategory, description: 'House-made vanilla syrup meets espresso and steamed oat milk.',           price: 5.50, image: '/templates/OHMT019-coffee/signature-latte.jpg',       options: ['hot', 'iced'] as ('hot' | 'iced')[],   isSignature: true },
  ...
  { id: '8',  name: 'Oat Milk Latte',        category: 'coffee'    as MenuCategory, description: 'Smooth oat milk espresso with a naturally sweet finish.',                 price: 5.50, image: '/templates/OHMT019-coffee/menu-oat-latte.jpg',         options: ['hot', 'iced'] as ('hot' | 'iced')[] },
  ...
  { id: '10', name: 'Matcha Latte',          category: 'coffee'    as MenuCategory, description: 'Ceremonial grade matcha whisked with steamed oat milk.',                  price: 5.50, image: '/templates/OHMT019-coffee/menu-matcha.jpg',           options: ['hot', 'iced'] as ('hot' | 'iced')[] },
  ...
  { id: '12', name: 'Cold Brew + Oat',       category: 'coffee'    as MenuCategory, description: 'Our signature cold brew topped with creamy oat milk.',                    price: 5.50, image: '/templates/OHMT019-coffee/menu-cold-brew-oat.jpg',     options: ['iced'] as ('hot' | 'iced')[] },
  ...
  { id: '15', name: 'Hibiscus Tea',          category: 'non-coffee' as MenuCategory, description: 'Floral hibiscus iced tea with agave and fresh mint.',                     price: 4.50, image: '/templates/OHMT019-coffee/menu-hibiscus.jpg',          options: ['hot', 'iced'] as ('hot' | 'iced')[] },
  ...
  { id: '18', name: 'Mint Green Tea',        category: 'non-coffee' as MenuCategory, description: 'Organic green tea with fresh mint and a touch of honey.',                 price: 4.50, image: '/templates/OHMT019-coffee/menu-green-tea.jpg',         options: ['hot', 'iced'] as ('hot' | 'iced')[] },
  ...
  { id: '20', name: 'Almond Croissant',      category: 'food'      as MenuCategory, description: 'Croissant filled with almond cream and sliced almonds.',                  price: 4.50, image: '/templates/OHMT019-coffee/menu-almond-croissant.jpg',  options: [] as ('hot' | 'iced')[] },
