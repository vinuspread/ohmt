...
export const menuItems = [
  { id: '1',  name: 'Double Espresso',       category: 'coffee'    as MenuCategory, description: 'Rich double shot with honey sweetness and lingering crema.',               price: 3.50, image: '/templates/OHMT019-coffee/menu-espresso-transparent.png',          options: ['hot'] as ('hot' | 'iced')[],           isSignature: true },
  ...
  { id: '11', name: 'Cold Brew',             category: 'coffee'    as MenuCategory, description: 'Slow-steeped 24 hours for a smooth, chocolatey finish.',                  price: 5.00, image: '/templates/OHMT019-coffee/menu-cold-brew-transparent.png',         options: ['iced'] as ('hot' | 'iced')[],           isSignature: true },
  ...
  { id: '19', name: 'Butter Croissant',      category: 'food'      as MenuCategory, description: 'French-style croissant, golden and flaky.',                               price: 4.00, image: '/templates/OHMT019-coffee/menu-croissant-transparent.png',         options: [] as ('hot' | 'iced')[] },
  { id: '20', name: 'Almond Croissant',      category: 'food'      as MenuCategory, description: 'Croissant filled with almond cream and sliced almonds.',                  price: 4.50, image: '/templates/OHMT019-coffee/menu-croissant-transparent.png',         options: [] as ('hot' | 'iced')[] },
