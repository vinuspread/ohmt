...
export const services = [
  { icon: "Swimming", title: "Infinity Pool", desc: "Overlook the horizon from our heated infinity edge pool with panoramic sea views." },
  { icon: "Spa", title: "Aman Spa", desc: "Ancient healing rituals meet modern wellness in our award-winning spa sanctuary." },
  { icon: "Dining", title: "Michelin Dining", desc: "Three signature restaurants helmed by world-renowned chefs." },
  { icon: "Fitness", title: "Wellness Center", desc: "State-of-the-art equipment, daily yoga, and personal training sessions." },
  { icon: "Concierge", title: "Concierge", desc: "24/7 personalized concierge service for reservations and experiences." },
  { icon: "Transport", title: "Private Transfer", desc: "Luxury fleet of vehicles with chauffeur service from and to the airport." }
];
