...
export function TemplateWrapper({ theme, children }: { theme: SpaTheme; children: React.ReactNode }) {
  ...
  return (
    <div style={cssVariables} className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] selection:bg-[var(--color-primary)] selection:text-[var(--color-text-contrast)]">
      <motion.div
