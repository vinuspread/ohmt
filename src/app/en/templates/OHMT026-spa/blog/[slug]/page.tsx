  ...
  return (
    <main className="min-h-screen bg-white px-6 py-24 text-neutral-950 md:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <Link href="/en/templates/OHMT026-spa/blog" className="mt-10 inline-flex min-h-11 items-center justify-center bg-neutral-950 px-6 text-sm font-bold text-white transition-colors hover:bg-neutral-700">Back to listing</Link>
      </div>
    </main>
  );
}
