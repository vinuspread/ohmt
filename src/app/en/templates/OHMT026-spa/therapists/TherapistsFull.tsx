...
const specializations = ["Laser Treatments", "Facial Rejuvenation", "Chemical Peels", "Microneedling", "Massage Therapy", "Aromatherapy", "Body Treatments", "Skin Consultation"];
