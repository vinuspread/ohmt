      ...
      <div className="max-w-[1440px] mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-12 border-b border-white/10">
          <div className="col-span-2 md:col-span-1">
            <span className="text-[1.4rem] font-extrabold tracking-[-0.02em] uppercase block mb-4">VINUS</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: t.footer.links.allProducts, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.newArrivals, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.bestSellers, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.sale, href: "/en/templates/OHMT005-sneaker/shop-all" },
              ].map(l => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: t.footer.links.sneakers, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.running, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.formal, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.boots, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.loafers, href: "/en/templates/OHMT005-sneaker/shop-all" },
              ].map(l => (
                <li key={l.label}><Link href={l.href} className="text-[0.85rem] text-white/70 hover:text-white transition-colors">{l.label}</Link></li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: t.footer.links.sizingGuide, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.shipping, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.returns, href: "/en/templates/OHMT005-sneaker/shop-all" },
                { label: t.footer.links.contact, href: "/en/templates/OHMT005-sneaker/contact" },
              ].map(l => (
                <li key={l.label}><Link href={l.href} className="text-[0.85rem] text-white/70 hover:text-white transition-colors">{l.label}</Link></li>
              ))}
            </ul>
