      ...
      <TemplateWrapper theme={theme}>
        ...
        <main className="min-h-screen flex items-center justify-center bg-[var(--color-bg)]">
          <div className="text-center">
            ...
            <h1 className="font-heading text-[clamp(2rem,4vw,4rem)] uppercase tracking-[-0.04em] mb-6">Exhibition Not Found</h1>
            <Link href="/en/templates/OHMT003-exhibition/exhibitions" className="text-[11px] font-semibold uppercase tracking-[0.12em] underline underline-offset-4">Back to Exhibitions</Link>
          </div>
        </main>
        <Footer />
      </TemplateWrapper>
        ...
        <section className="bg-[var(--color-bg)] border-b border-[var(--color-border)]">
          <div className="max-w-[1400px] mx-auto px-6 py-20 md:py-28">
            <div className="max-w-[720px]">
              ...
              <p
                className="text-[15px] font-body text-black/65 leading-[1.8]"
