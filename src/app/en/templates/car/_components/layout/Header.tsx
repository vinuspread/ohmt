// src/app/templates/car/-components/layout/Header.tsx
"use client";
    ...
    <>
      <nav className={clsx(
        ...
        <div className="max-w-[var(--theme-container)] mx-auto px-6 md:px-[var(--theme-gutter)] flex items-center justify-between w-full">
          <Link href="/en/templates/OHMT009-car-EN" className="text-[0.95rem] font-bold tracking-[0.25em] uppercase text-white">
          ...
          <div className="hidden md:flex gap-10 absolute left-1/2 -translate-x-1/2">
            {NAV_ITEMS.map((item) => (
                <Link
                  key={item.id}
                  href={`/en/templates/OHMT009-car-EN/${item.id}`}
