      ...
      <TemplateWrapper theme={theme}>
        <main className="antialiased bg-black text-white min-h-screen flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center flex-col gap-6 pt-12 md:pt-24">
            ...
            <Link href="/en/templates/OHMT017-car-en/models" className="text-[0.75rem] uppercase tracking-[0.14em] text-[var(--theme-accent)] border-b border-[var(--theme-accent)] pb-0.5">??All Models</Link>
          </div>
        </main>
      </TemplateWrapper>
    );
      ...
      <main className="antialiased bg-black text-white selection:bg-[var(--theme-accent)] selection:text-black">
        ...
        <section className="relative h-[90vh] min-h-[560px] overflow-hidden flex items-end">
          ...
          <div className="relative w-full max-w-[var(--theme-container)] mx-auto px-6 md:px-[var(--theme-gutter)] pb-16 md:pb-24">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/en/templates/OHMT017-car-en/configure" className="inline-block text-[0.68rem] font-bold uppercase tracking-[0.16em] px-8 py-3 bg-[var(--theme-accent)] text-black hover:opacity-85 transition-opacity w-fit">
                Configure Your {model.name}
              </Link>
              <Link href="/en/templates/OHMT017-car-en/models" className="inline-block text-[0.68rem] font-bold uppercase tracking-[0.16em] px-8 py-3 border border-white/25 text-white hover:border-white transition-colors w-fit">
                ??All Models
              </Link>
            </div>
          </div>
        ...
        <section className="bg-[var(--color-primary)] border-t border-[var(--theme-border)]">
          <div className="max-w-[var(--theme-container)] mx-auto px-6 md:px-[var(--theme-gutter)] py-14 md:py-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/en/templates/OHMT017-car-en/configure" className="text-[0.68rem] font-bold uppercase tracking-[0.16em] px-8 py-3.5 bg-[var(--theme-accent)] text-black hover:opacity-85 transition-opacity">
                Build & Price
              </Link>
              <Link href="/en/templates/OHMT017-car-en" className="text-[0.68rem] font-bold uppercase tracking-[0.16em] px-8 py-3.5 border border-white/25 text-white hover:border-white transition-colors">
                Book Test Drive
              </Link>
            </div>
          </div>
