...
export function TemplateWrapper({ theme, children }: { theme: GameTheme; children: React.ReactNode }) {
  ...
  return (
    <div style={cssVariables} className="min-h-screen bg-[var(--theme-primary)] text-[var(--theme-text)] antialiased">
      <motion.div
