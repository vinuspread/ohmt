...
import type { NewsItem } from "../../data/data";
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <h3 className="mt-3 font-[var(--font-heading)] text-lg font-bold leading-[1.05] text-[var(--color-text)] group-hover:text-[var(--color-primary)] transition-colors">
          {item.title}
        </h3>
