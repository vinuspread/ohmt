  ...
  return (
    ...
    >
      <Link
        ...
        className="group block overflow-hidden rounded-2xl bg-[var(--color-bg-secondary)] border border-[var(--color-border)] transition-all duration-500 hover:border-[var(--color-primary)] hover:shadow-[0_0_30px_var(--color-primary-glow-medium)]"
      >
        ...
        <div className="p-5">
          ...
          <div className="mt-2 flex items-center justify-between">
            <span className="text-sm text-[var(--color-text-muted)]">{game.releaseYear}</span>
            {game.rating > 0 && (
