      ...
      <main className="antialiased min-h-screen pt-16 md:pt-20 bg-white text-[var(--color-text)]">
        <section className="bg-[var(--color-bg-secondary)] py-20">
          <div className="max-w-[1440px] mx-auto px-6 md:px-12 text-center">
            <p className="text-xs uppercase tracking-[0.3em] text-[var(--color-text-muted)] mb-4">Find Us</p>
            <h1 className="text-5xl lg:text-6xl font-bold tracking-tight">Our Locations</h1>
            <p className="text-base text-[var(--color-text-muted)] mt-4 max-w-md mx-auto">
              We are growing. Come visit us at one of our locations worldwide.
            </p>
          </div>
        </section>
