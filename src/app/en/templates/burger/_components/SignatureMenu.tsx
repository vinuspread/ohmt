    ...
    <section className="bg-[var(--color-bg-secondary)] py-24 md:py-32">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          <p className="text-xs uppercase tracking-[0.3em] text-[var(--color-text-muted)] mb-4">Signature Selection</p>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Our Signature Burgers</h2>
        </div>
