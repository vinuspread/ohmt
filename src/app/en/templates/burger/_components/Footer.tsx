      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-16 pb-8 md:pt-20 md:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link href="/en/templates/OHMT018-burger-EN" className="text-xl font-bold tracking-tight text-white">
              Oh My Template
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/en/templates/OHMT018-burger-EN/menu" className="text-sm text-white/60 hover:text-white transition-colors">Burgers</Link>
              <Link href="/en/templates/OHMT018-burger-EN/menu" className="text-sm text-white/60 hover:text-white transition-colors">Chicken</Link>
              <Link href="/en/templates/OHMT018-burger-EN/menu" className="text-sm text-white/60 hover:text-white transition-colors">Sides</Link>
              <Link href="/en/templates/OHMT018-burger-EN/menu" className="text-sm text-white/60 hover:text-white transition-colors">Shakes</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/en/templates/OHMT018-burger-EN/about" className="text-sm text-white/60 hover:text-white transition-colors">About Us</Link>
              <Link href="/en/templates/OHMT018-burger-EN/locations" className="text-sm text-white/60 hover:text-white transition-colors">Locations</Link>
