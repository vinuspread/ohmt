...
export const Header = () => {
  ...
  const navLinks = [
    { name: "Menu", href: "/en/templates/burger/menu" },
    { name: "About", href: "/en/templates/burger/about" },
    { name: "Locations", href: "/en/templates/burger/locations" },
  ];

  const isHome = pathname === "/en/templates/burger";
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between h-full">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium tracking-wide">
              ...
              return (
                <div key={link.href} className="relative group py-4">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 top-full hidden group-hover:block bg-white text-black shadow-lg py-2 w-40 border border-neutral-100">
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Set Menu</Link>
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Burgers</Link>
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Chicken</Link>
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Sides</Link>
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Desserts</Link>
                    <Link href="/en/templates/burger/menu" className="block px-4 py-2 text-xs hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-primary)] transition-colors">Drinks</Link>
                  </div>
                </div>
              );
            }
          ...
          <Link
            href="/en/templates/burger/order"
