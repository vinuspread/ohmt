      ...
      <div className="pb-16 md:pb-32 px-6 max-w-[1440px] mx-auto pt-16 space-y-16">
        ...
        {category.type === "engagement" && (
          <div className="space-y-36">
            ...
            <div className="border-t border-b border-neutral-200/50 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-[#FCFAF6] px-8 md:px-14 rounded-none normal-case">
