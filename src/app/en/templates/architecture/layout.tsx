// src/app/en/templates/OHMT027-architecture-EN/layout.tsx
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Architecture Portfolio - Oh My Template",
    description: "A sophisticated architecture portfolio template with editorial typography and immersive visual storytelling.",
    url: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN",
  ...
  alternates: {
    canonical: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN",
    languages: {
      "ko": "https://ohmytemplate.com/ko/templates/OHMT027-architecture-KO",
    },
  },
};
