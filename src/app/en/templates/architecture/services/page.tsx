// src/app/en/templates/OHMT027-architecture-EN/services/page.tsx
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Services - Architecture Portfolio - Oh My Template",
    description: "Explore our professional disciplines, from high-end residential design and commercial architecture to interior planning.",
    url: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN/services",
    images: [{ url: "/templates/architecture/og-image.jpg" }],
  },
  alternates: {
    canonical: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN/services",
    languages: {
      "ko": "https://ohmytemplate.com/ko/templates/OHMT027-architecture-KO/services",
    },
  },
};
