// src/app/en/templates/OHMT027-architecture-EN/projects/page.tsx
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Projects Portfolio - Architecture Portfolio - Oh My Template",
    description: "Browse our selected residential, commercial, public, and interior architecture commissions.",
    url: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN/projects",
    images: [{ url: "/templates/architecture/og-image.jpg" }],
  },
  alternates: {
    canonical: "https://ohmytemplate.com/en/templates/OHMT027-architecture-EN/projects",
    languages: {
      "ko": "https://ohmytemplate.com/ko/templates/OHMT027-architecture-KO/projects",
    },
  },
};
