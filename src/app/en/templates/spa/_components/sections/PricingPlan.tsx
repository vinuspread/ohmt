      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mt-5 text-[0.95rem] text-[var(--color-text-muted)] leading-relaxed max-w-md mx-auto">
            No hidden fees. No surprise charges. Choose the plan that fits your lifestyle.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 lg:grid-cols-3 items-start max-w-5xl mx-auto">
          {pricingPlans.map((plan, i) => (
            ...
            >
              ...
              <h3 className="font-[family-name:var(--font-heading)] text-xl font-bold tracking-tight text-[var(--color-text)]">
                {plan.name}
              </h3>
              <div className="mt-4 flex items-baseline gap-1">
                <span className="font-[family-name:var(--font-heading)] text-5xl font-bold text-[var(--color-text)]">
                  {plan.price}
                </span>
