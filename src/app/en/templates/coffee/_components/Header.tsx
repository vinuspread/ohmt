...
export const Header = () => {
  ...
  const navLinks = [
    { name: "Menu", href: "/en/templates/coffee/menu" },
    { name: "About", href: "/en/templates/coffee/about" },
    { name: "Locations", href: "/en/templates/coffee/locations" },
  ];

  const isHome = pathname === "/en/templates/coffee";
