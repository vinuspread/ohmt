    ...
    <div>
      <section className="py-20 lg:py-28">
        ...
        <div className="mt-4 grid grid-cols-12 gap-y-6 sm:gap-x-10 lg:items-end">
          <h1 className="col-span-12 font-[family-name:var(--font-heading)] text-4xl font-semibold leading-tight sm:text-6xl lg:col-span-7">Fruit boxes packed around the current crop.</h1>
