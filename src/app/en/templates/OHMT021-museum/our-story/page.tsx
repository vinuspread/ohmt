...
function MuseumInfoContent() {
  ...
  "ourStory": {
    ...
    "silentVatican": `Vatican Spaces and History`,
    "grottoesTitle": `Spaces and Memory`,
    "grottoes": [
      {
        "name": `Tomb of Pope Gregory XVI`,
        "title": `Historic Tomb`,
        "desc": `The seated papal figure, inscription, and candles reveal the Vatican's tradition of funerary sculpture and remembrance.`
      },
      {
        "name": `Circular Dome Gallery`,
        "title": `Architecture and Light`,
        "desc": `A circular oculus, colonnade, and curved stairway show how proportion and natural light shape Vatican architecture.`
      },
      {
        "name": `Sculpture Gallery`,
        "title": `Ancient Sculpture Collection`,
        "desc": `Marble figures and portrait busts line the long gallery, presenting ancient sculpture by period and subject.`
      }
    ],
          ...
          <div className="flex flex-col gap-20 relative">
            ...
            {timelineData.map((evt, i: number) => (
              <motion.div key={i} initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: i * 0.1 }} className="pl-16 relative">
                ...
                <p className="text-sm text-white/50 font-normal leading-[var(--leading-body)] max-w-xl break-keep">{evt.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-[1440px] mx-auto px-8 md:px-16 py-10 md:py-20 md:py-32 lg:py-40 border-b border-white/5">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-center mb-40">
          ...
          <div className="space-y-10">
            ...
            <span className="text-xs uppercase font-bold tracking-[0.5em] text-white/20">{t.ourStory.altarDate}</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {grottoes.map((item, i: number) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: i * 0.1 }} className="group">
                ...
                <p className="text-sm font-normal leading-[var(--leading-body)] text-white/50 break-keep">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
