...
const PANELS = [
  { image: "/templates/yoga/class-vinyasa.jpg", label: "Vinyasa Flow", sub: "Dynamic Movement", href: "/en/templates/yoga/classes/vinyasa-flow" },
  { image: "/templates/yoga/class-hatha.jpg", label: "Hatha Yoga", sub: "Stillness & Breath", href: "/en/templates/yoga/classes/hatha-yoga" },
  { image: "/templates/yoga/class-meditation.jpg", label: "Meditation", sub: "Inner Quiet", href: "/en/templates/yoga/classes/meditation" },
  { image: "/templates/yoga/class-pilates.jpg", label: "Pilates", sub: "Core & Alignment", href: "/en/templates/yoga/classes/pilates" },
];
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 px-8 md:px-14 lg:px-20 pb-8 md:pb-14 lg:pb-20 pt-20 bg-gradient-to-t from-black/60 via-black/20 to-transparent">
              ...
              <div className="mt-5 overflow-hidden transition-all duration-500 ease-out max-h-0 group-hover:max-h-10">
                <span
                  className="inline-flex items-center gap-2 text-[11px] tracking-[0.2em] uppercase text-white border-b border-white/50 pb-0.5 font-medium"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Book Class &rarr;
                </span>
