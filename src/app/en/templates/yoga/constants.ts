...
export const NAV_ITEMS = [
  { label: "Home", href: "/en/templates/yoga" },
  { label: "Classes", href: "/en/templates/yoga/classes" },
  { label: "About", href: "/en/templates/yoga/about" },
  { label: "Book", href: "/en/templates/yoga/schedule" },
  { label: "My Page", href: "/en/templates/yoga/mypage" },
] as const;
