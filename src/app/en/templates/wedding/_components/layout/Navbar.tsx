...
const navLinks = [
  { href: "/en/templates/wedding/about", label: "About" },
  { href: "/en/templates/wedding/gallery", label: "Gallery" },
  { href: "/en/templates/wedding/pricing", label: "Pricing" },
  { href: "/en/templates/wedding/contact", label: "Contact" },
];
