...
export const designerInfo = {
  ...
  nav: [
    { num: '_01', name: 'Works', href: '/en/templates/OHMT007-portfolio' },
    { num: '_02', name: 'About', href: '/en/templates/OHMT007-portfolio/about' },
    { num: '_03', name: 'Journal', href: '/en/templates/OHMT007-portfolio/journal' },
    { num: '_04', name: 'Contact', href: '/en/templates/OHMT007-portfolio/contact' },
  ]
};
...
export const testimonials = [
  { name: 'Sarah Conor', role: 'CEO, Clonify', text: 'HALF LIGHT transformed our brand identity from a forgettable logo into a cohesive visual language. The attention to detail is unmatched.', img: '/templates/OHMT007-portfolio/portfolio-1.png' },
  { name: 'Bruce Lee', role: 'Founder, Maiz', text: 'Working with them felt less like hiring an agency and more like gaining a creative partner. They understood our vision before we could articulate it.', img: '/templates/OHMT007-portfolio/portfolio-2.png' },
  { name: 'Elena Marco', role: 'CMO, Marcom', text: 'The website they built for us drove a 340% increase in qualified leads within the first quarter. Design that actually converts.', img: '/templates/OHMT007-portfolio/portfolio-3.png' },
];
...
export const blogPosts = [
  { slug: 'crafting-brand-identity', title: 'Inside the Studio: Our Process for Crafting a Standout Identity', date: 'May 23, 2026', category: 'Process', img: '/templates/OHMT007-portfolio/portfolio-4.png' },
  { slug: 'sketch-to-screen', title: 'From Sketch to Screen: How Ideas Evolve Into Impactful Designs', date: 'May 10, 2026', category: 'Design', img: '/templates/OHMT007-portfolio/portfolio-5.png' },
  { slug: 'visual-language', title: 'Why Every Brand Needs a Signature Visual Language', date: 'Apr 28, 2026', category: 'Branding', img: '/templates/OHMT007-portfolio/portfolio-6.png' },
];
