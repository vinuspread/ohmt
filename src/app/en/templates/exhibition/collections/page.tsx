          ...
          <AnimatePresence initial={false}>
            {displayedItems.map((item) => (
                <motion.div
                  ...
                  className="relative group overflow-hidden bg-[#151515] aspect-[3/4]"
                >
                  <Link href={`/en/templates/exhibition/collections/${item.slug}`} className="block w-full h-full cursor-pointer">
                    <img 
                      src={item.img} 
                      alt={item.title}
