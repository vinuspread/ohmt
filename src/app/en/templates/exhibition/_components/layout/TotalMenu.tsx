...
const menuItems = [
  ...
  { name: "Museum Info", href: "/templates/exhibition/our-story", desc: "Our 500-Year Legacy" },
  { name: "Collections", href: "/templates/exhibition/collections", desc: "Explore the Archive" },
  { name: "Exhibitions", href: "/templates/exhibition/exhibitions", desc: "Current & Special Showings" },
  { name: "Souvenir Shop", href: "/templates/exhibition/souvenir", desc: "Echos of History" },
  { name: "Curator Note", href: "/templates/exhibition/curator-note", desc: "Theological Insights" },
];
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-8 right-8 md:top-12 md:right-12 hover:rotate-90 transition-transform duration-300"
          >
            <X size={32} />
          </button>
