    ...
    <section className="bg-[var(--color-bg-secondary)] py-20 md:py-28">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="mb-10 flex items-end justify-between">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Latest Insights</h2>
          <Link
            href="/en/templates/OHMT017-multi-shop/blog"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {blogPosts.map((post, index) => (
            ...
            >
              <Link
                href={`/en/templates/OHMT017-multi-shop/blog/${post.slug}`}
              ...
              >
                ...
                <div className="mt-5">
                  ...
                  <h3 className="text-base font-bold mt-2 leading-[1.05] motion-safe:group-hover:opacity-70 transition-opacity duration-200">
                    {post.title}
                  </h3>
