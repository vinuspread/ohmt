// src/app/templates/cosmetic/-components/layout/Footer.tsx
"use client";
    ...
    <footer className="bg-black text-white py-12 md:py-24">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-20 mb-20">
          <div>
            <Link href="/en/templates/cosmetic" className="text-[1rem] md:text-[1.15rem] font-medium md:font-black tracking-[0.12em] uppercase mb-8 block">
              VINUSPREAD
            </Link>
