    ...
    <>
      <header className={`bg-white border-b border-zinc-200/60 px-5 sm:px-6 md:px-12 lg:px-20 py-4 flex justify-between items-center fixed top-0 left-0 right-0 z-40 transition-transform duration-300 dark:bg-zinc-900 dark:border-zinc-800 ${headerVisible ? "translate-y-0" : "-translate-y-full"}`}>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          <Link href="/ko/contact" className="hidden sm:inline-flex text-xs uppercase tracking-widest text-zinc-400 hover:text-zinc-900 transition-colors font-bold dark:text-zinc-500 dark:hover:text-zinc-100">
            KR
          </Link>
          <Link
            href="/en/contact"
          ...
          <button
            ...
            aria-controls="mobile-menu-en-contact"
          ...
          >
            ...
            >
              ...
              <div className="flex min-h-0 flex-1 flex-col justify-center px-5 pb-6 sm:px-6">
                ...
                >
                  <Link href="/ko/contact" onClick={handleCloseMenu} className="inline-flex min-h-11 items-center text-[1.375rem] font-bold text-zinc-300 outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F1B100] active:text-[#F1B100]">
                    Korean
                  </Link>
                </motion.div>
              </div>
