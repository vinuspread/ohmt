    ...
    return (
      <div className="flex flex-col items-center justify-center gap-6 py-24 text-center">
        ...
        <div className="space-y-2">
          <p className="text-zinc-900 text-base font-bold dark:text-zinc-100">Your inquiry has been submitted.</p>
                    ...
                    <div className="space-y-3 px-1 pt-1">
                      {industries.length > 0 && (
                        <div className="space-y-1">
                          <p className="text-[0.58rem] uppercase tracking-widest text-zinc-400 font-bold dark:text-zinc-500">Applicable Industries</p>
                          <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">{industries.join(", ")}</p>
                        </div>
                      )}
                      {desc && (
                        <div className="space-y-1">
                          <p className="text-[0.58rem] uppercase tracking-widest text-zinc-400 font-bold dark:text-zinc-500">About</p>
            ...
            {requiresConsultation && (
              <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950/30">
                ...
                <p className="mt-1 text-xs leading-relaxed text-amber-700 dark:text-amber-500">
                  Pricing can vary by requirements and feature scope. Submit your inquiry and our team will guide you directly.
                </p>
              </div>
            )}
                ...
                <div>
                  ...
                  <SelectField
                    ...
                    options={[
                      ...
                      { value: "Under ₩10M", label: "Under ₩10,000,000" },
                      { value: "Under ₩20M", label: "Under ₩20,000,000" },
