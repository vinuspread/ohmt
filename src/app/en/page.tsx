...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://ohmt.site/og-share-v2.png", secureUrl: "https://ohmt.site/og-share-v2.png", width: 1200, height: 630, alt: "Oh My Template — Premium Website Templates", type: "image/png" }],
  },
  twitter: {
