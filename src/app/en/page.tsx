...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://ohmt.site/og-share.png", secureUrl: "https://ohmt.site/og-share.png", width: 1200, height: 600, alt: "Oh My Template — Premium Website Templates", type: "image/png" }],
  },
  twitter: {
