...
export default function LandingPageClient({ templates: templatesProp, faqs, packages }: { templates: TemplateItem[]; faqs: FaqItem[]; packages: PricingPackage[] }) {
  ...
  const webPageSchema = {
    ...
    "@type": "CollectionPage",
    "@id": "https://ohmt.site/en#webpage",
    url: "https://ohmt.site/en",
    name: "Oh My Template | Custom Websites for Businesses and Brands",
    inLanguage: "en",
      ...
      <section className="pt-20 pb-9 bg-white border-b border-zinc-200/50 relative overflow-hidden dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <div className="relative">
          ...
          <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
            ...
            <h1 className="mt-10 text-[2.1rem] sm:text-[2.8rem] md:text-[4.25rem] font-bold tracking-tight leading-[1.25] md:leading-[1.1] text-zinc-900 dark:text-zinc-100">
              Custom websites, built around your brand.
            </h1>
