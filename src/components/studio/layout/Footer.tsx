        ...
        <footer className="bg-[#090B19] text-white px-[64px] py-[120px] border-t border-white/10">
            <div className="max-w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-[96px] mb-[120px]">
                ...
                <div className="lg:col-span-4 flex flex-col justify-between h-full">
                    <div>
                         <Link href="/studio" className="text-[48px] leading-[58px] font-semibold tracking-[-1.44px] uppercase mb-[64px] block">
                            vinuspread.
                        </Link>
                ...
                <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-[64px]">
                    ...
                    <div className="flex flex-col gap-[32px]">
                        ...
                        <div className="flex flex-col gap-[24px]">
                            <Link href="/studio" className="text-[11px] font-bold tracking-[3px] uppercase hover:opacity-60 transition-opacity">Home</Link>
                            <Link href="/studio/services" className="text-[11px] font-bold tracking-[3px] uppercase hover:opacity-60 transition-opacity">Services</Link>
                            <Link href="/studio/projects" className="text-[11px] font-bold tracking-[3px] uppercase hover:opacity-60 transition-opacity">Projects</Link>
                        </div>
                    </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-[64px] border-t border-white/10">
                ...
                <div className="flex gap-[48px] mt-8 md:mt-0">
                    <Link href="/studio/privacy" className="text-[11px] font-normal tracking-[3px] uppercase opacity-40 hover:opacity-100 transition-opacity">Privacy Policy</Link>
                    <Link href="/studio/terms" className="text-[11px] font-normal tracking-[3px] uppercase opacity-40 hover:opacity-100 transition-opacity">Terms of Service</Link>
                </div>
            </div>
        </footer>
    );
