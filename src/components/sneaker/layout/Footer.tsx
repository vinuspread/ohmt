            ...
            <div className="max-w-[1440px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-brand-border pb-24 gap-12 lg:gap-0">
                    ...
                    <div className="lg:col-span-6 space-y-10 lg:pr-24">
                        <Link href="/sneaker" className="font-black text-3xl tracking-tighter uppercase inline-block">
                            vinuspread
                        </Link>
                    ...
                    <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-3 h-full">
                        <div className="border-t lg:border-t-0 lg:border-l border-brand-border p-8 lg:p-10 space-y-20">
                            ...
                            <ul className="space-y-4 text-[16px] font-bold tracking-tight">
                                <li><Link href="/sneaker/shop-all" className="hover:opacity-50 transition-opacity">Shop All</Link></li>
                                <li><Link href="/sneaker/new-drops" className="hover:opacity-50 transition-opacity">New Drops</Link></li>
                                <li><Link href="/sneaker/innovations" className="hover:opacity-50 transition-opacity">Innovations</Link></li>
                                <li><Link href="/sneaker/archive" className="hover:opacity-50 transition-opacity">Archive</Link></li>
                            </ul>
                        </div>
                        <div className="border-t lg:border-t-0 border-l border-brand-border p-8 lg:p-10 space-y-20">
                            ...
                            <ul className="space-y-4 text-[16px] font-bold tracking-tight">
                                <li><Link href="/sneaker/stories" className="hover:opacity-50 transition-opacity">Stories</Link></li>
                                <li><Link href="/sneaker/about-us" className="hover:opacity-50 transition-opacity">About Us</Link></li>
                                <li><Link href="/sneaker/journal" className="hover:opacity-50 transition-opacity">Journal</Link></li>
                                <li><Link href="/sneaker/careers" className="hover:opacity-50 transition-opacity">Careers</Link></li>
                            </ul>
                        </div>
                        <div className="border-t lg:border-t-0 border-l border-brand-border p-8 lg:p-10 space-y-20 col-span-2 md:col-span-1">
                            ...
                            <ul className="space-y-4 text-[16px] font-bold tracking-tight">
                                <li><Link href="/sneaker/shipping" className="hover:opacity-50 transition-opacity">Shipping</Link></li>
                                <li><Link href="/sneaker/returns" className="hover:opacity-50 transition-opacity">Returns</Link></li>
                                <li><Link href="/sneaker/contact" className="hover:opacity-50 transition-opacity">Contact Us</Link></li>
                                <li><Link href="/sneaker/sizing" className="hover:opacity-50 transition-opacity">Sizing Guide</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex flex-col md:flex-row gap-8 items-center text-[11px] font-bold tracking-wider text-brand-secondary/30 uppercase">
                        ...
                        <div className="flex gap-6">
                            <Link href="/sneaker/privacy" className="hover:text-brand-secondary">Privacy Policy</Link>
                            <Link href="/sneaker/terms" className="hover:text-brand-secondary">Terms of Service</Link>
                        </div>
                    </div>
