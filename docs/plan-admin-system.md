...
('airline', 'Airline', '에어라인', 'hospitality', 'Premium airline booking template', '프리미엄 항공 예약 템플릿', '/templates/airline/og-image.jpg', 0, 'published', 1, false),
('car', 'Car Showroom', '자동차 쇼룸', 'retail', 'Luxury car showroom template', '럭셔리 자동차 쇼룸 템플릿', '/templates/car/og-image.jpg', 0, 'published', 2, false),
('cosmetic', 'Cosmetic Store', '코스메틱 스토어', 'lifestyle', 'Beauty and cosmetic store template', '뷰티 코스메틱 스토어 템플릿', '/templates/cosmetic/og-image.jpg', 0, 'published', 3, false),
('dashboard', 'Dashboard', '대시보드', 'service', 'Analytics dashboard template', '분석 대시보드 템플릿', '/templates/dashboard/og-image.jpg', 0, 'published', 4, false),
('docs', 'Documentation', '문서 시스템', 'service', 'Documentation workspace template', '문서 협업 워크스페이스 템플릿', '/templates/docs/og-image.jpg', 0, 'published', 5, false),
('exhibition', 'Exhibition', '전시관', 'portfolio', 'Museum and exhibition template', '미술관 전시 템플릿', '/templates/exhibition/og-image.jpg', 0, 'published', 6, false),
('fashion', 'Fashion Store', '패션 스토어', 'lifestyle', 'Elegant fashion store template', '엘레강트한 패션 스토어 템플릿', '/templates/fashion/og-image.jpg', 0, 'published', 7, false),
('furniture', 'Furniture Modern', '퍼니처 모던', 'retail', 'Modern furniture store template', '현대적인 가구 스토어 템플릿', '/templates/furniture/og-image.jpg', 0, 'published', 8, false),
('ir', 'IR', 'IR', 'corporate', 'Investor relations template', '투자자 관계(IR) 템플릿', '/templates/ir/og-image.jpg', 0, 'published', 9, false),
('jewelry', 'Jewelry', '주얼리', 'lifestyle', 'Luxury jewelry store template', '럭셔리 주얼리 스토어 템플릿', '/templates/jewelry/og-image.jpg', 0, 'published', 10, false),
('magazine', 'Magazine', '매거진', 'media', 'Editorial magazine template', '에디토리얼 매거진 템플릿', '/templates/magazine/og-image.jpg', 0, 'published', 11, false),
('multi-shop', 'Multi Shop', '멀티샵', 'retail', 'Multi-category shop template', '멀티 카테고리 쇼핑 템플릿', '/templates/multi-shop/og-image.jpg', 0, 'published', 12, false),
('newspaper', 'Newspaper', '신문', 'media', 'Online newspaper template', '온라인 신문 템플릿', '/templates/newspaper/og-image.jpg', 0, 'published', 13, false),
('portfolio', 'Portfolio', '포트폴리오', 'portfolio', 'Creative portfolio template', '크리에이티브 포트폴리오 템플릿', '/templates/portfolio/og-image.jpg', 0, 'published', 14, false),
('sneaker', 'Sneaker Store', '스니커 스토어', 'retail', 'Sneaker and streetwear store template', '스니커 스트리트웨어 스토어 템플릿', '/templates/sneaker/og-image.jpg', 0, 'published', 15, false),
('studio', 'Studio', '스튜디오', 'portfolio', 'Creative studio template', '크리에이티브 스튜디오 템플릿', '/templates/studio/og-image.jpg', 0, 'published', 16, false),
('technology', 'Technology - Robotflow', '테크놀로지 - 로봇플로우', 'corporate', 'AI robotics company template', 'AI 로봇 기업 템플릿', '/templates/technology/og-image.jpg', 0, 'published', 17, true);
```
