...
|------|------|
| 사이트명 | OHMT |
| 정식 도메인 | https://ohmt.site |
| 목적 | 프리미엄 웹사이트 템플릿 및 맞춤형 웹사이트 제작 서비스 |
| 언어 | 한국어(`/ko`), 영어(`/en`) |
| canonical 기준 | 항상 `https://ohmt.site` (www 없음) |

---

## 타깃 사용자

- 웹사이트가 필요한 소상공인, 브랜드, 스타트업
- 템플릿 기반으로 빠르게 홈페이지를 만들고 싶은 고객
- 템플릿 외 맞춤형 웹사이트/앱/서비스 제작을 원하는 고객
...
> **주의**: `<meta name="keywords">`는 사용하지 않는다. 키워드는 title, description, H1/H2, 본문, 구조화 데이터에 자연스럽게 녹여 사용한다.
...
| | 영문 `/en` | 국문 `/ko` |
|--|--|--|
| **title** | Premium Website Templates & Custom Web Design \| OHMT | 웹사이트 템플릿 & 맞춤형 홈페이지 제작 \| OHMT |
| **description** | OHMT provides premium website templates and custom web design services for brands, businesses, portfolios, shops, magazines, and digital products. Ready in 2 days. | OHMT는 비즈니스 목적에 맞는 프리미엄 웹사이트 템플릿과 맞춤형 홈페이지 제작 서비스를 제공합니다. 템플릿 선택부터 커스터마이징, 기능 개발까지 상담을 통해 진행합니다. |
| **H1 방향** | Premium Website Templates for Modern Businesses | 프리미엄 웹사이트 템플릿과 맞춤형 제작 |
| **canonical** | https://ohmt.site/en | https://ohmt.site/ko |

### Contact 페이지

| | 영문 `/en/contact` | 국문 `/ko/contact` |
|--|--|--|
| **title** | Contact & Custom Web Design Inquiry \| OHMT | 문의 & 맞춤형 홈페이지 제작 상담 \| OHMT |
| **description** | Get in touch with OHMT for custom website design, template-based builds, or general inquiries. We respond within 1 business day. | OHMT에 웹사이트 제작, 템플릿 기반 홈페이지, 맞춤형 개발 등을 문의해주세요. 영업일 기준 1일 이내 답변 드립니다. |
| **canonical** | https://ohmt.site/en/contact | https://ohmt.site/ko/contact |
...
|------|-------|-------------|
| airline | Airline Brand Website Template \| OHMT | A premium airline and aviation brand website template. Professional design for airlines, charter services, and aviation companies. |
| architecture | Architecture Portfolio Website Template \| OHMT | A sophisticated architecture portfolio website template with project galleries, design philosophy, and studio services pages. |
| burger | Burger Restaurant Website Template \| OHMT | A bold website template for burger restaurants, fast food chains, and food brands. Includes menu, promotions, and location pages. |
| car | Automotive & Car Brand Website Template \| OHMT | A sleek automotive website template for car brands, dealerships, and vehicle showcases. |
...
| ir | Investor Relations Website Template \| OHMT | A professional investor relations website template with financial highlights and shareholder information. |
| jewelry | Jewelry & Luxury Brand Website Template \| OHMT | An elegant jewelry website template with curated product collections and brand heritage story. |
...
| slug | title |
|------|-------|
| airline | 항공사 브랜드 웹사이트 템플릿 \| OHMT |
| architecture | 건축 포트폴리오 웹사이트 템플릿 \| OHMT |
| burger | 버거 레스토랑 웹사이트 템플릿 \| OHMT |
| car | 자동차 브랜드 웹사이트 템플릿 \| OHMT |
...
| ir | 기업 IR 웹사이트 템플릿 \| OHMT |
| jewelry | 주얼리·럭셔리 브랜드 웹사이트 템플릿 \| OHMT |
...
| yoga | 요가·웰니스 스튜디오 웹사이트 템플릿 \| OHMT |
...
og:description → 페이지 description과 동일 (또는 요약)
og:url         → canonical URL과 동일
og:site_name   → "OHMT"
og:type        → "website"
og:image       → 템플릿: /templates/{slug}/og-image.jpg (1200×630)
                 메인/contact: /og-image.png (1200×630)
...
### 향후 추가 검토
- 템플릿 상세: `Service` 또는 `CreativeWork`
- Contact 페이지: `ContactPage`
- 랜딩 페이지: `BreadcrumbList`

> 실제 없는 가격, 평점, 리뷰는 절대 포함하지 않는다.

---

## 다국어 처리

- `/en`과 `/ko`는 각각 `canonical`이 자기 자신을 가리킨다
- `alternates.languages`로 상호 hreflang 연결
- `x-default`는 `/en`으로 설정
- 루트 `/`는 proxy.ts에서 Accept-Language/IP 기반으로 `/en` 또는 `/ko`로 리다이렉트

---

## 이미지 SEO 기준

- 템플릿 썸네일 `alt`: `"{Template Name} website template preview"`
- OG 이미지 `alt`: `"{Page Title}"` 또는 `"OHMT — {description}"`
- 장식용 이미지: `alt=""`
- 주요 콘텐츠 이미지: 용도를 설명하는 alt 텍스트 필수
